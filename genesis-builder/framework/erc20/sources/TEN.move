module ERC20::xdd16ec0f66e54d453e6756713e533355989040e4 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"TEN";
    const ASSET_NAME: vector<u8> = b"Tokenomy";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/TEN/logo.svg"), /* icon */
            utf8(b"https://tokenomy.com/"), /* project */
        );
