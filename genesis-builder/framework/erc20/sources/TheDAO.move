module ERC20::xbb9bc244d798123fde783fcc1c72d3bb8c189413 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"TheDAO";
    const ASSET_NAME: vector<u8> = b"TheDAO";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            16, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/TheDAO/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
