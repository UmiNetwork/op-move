module ERC20::xcAfE001067cDEF266AfB7Eb5A286dCFD277f3dE5 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"PSP";
    const ASSET_NAME: vector<u8> = b"ParaSwap";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/PSP/logo.svg"), /* icon */
            utf8(b"https://www.paraswap.io"), /* project */
        );
