module ERC20::x3C513dB8Bdc3806e4489d62C3d549A5Aaf6A4e97 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"BitBTC";
    const ASSET_NAME: vector<u8> = b"BitBTC";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/BitBTC/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
