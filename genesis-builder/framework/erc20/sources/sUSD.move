module ERC20::x57ab1ec28d129707052df4df418d58a2d46d5f51 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"sUSD";
    const ASSET_NAME: vector<u8> = b"Synthetix USD";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/sUSD/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
