module ERC20::x0c90C57aaf95A3A87eadda6ec3974c99D786511F {
    ...
    const ASSET_SYMBOL: vector<u8> = b"HAN";
    const ASSET_NAME: vector<u8> = b"HanChain";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/HAN/logo.svg"), /* icon */
            utf8(b"https://www.khans.io/"), /* project */
        );
