module ERC20::xd17d5c95B9183354eF24866b61480FC53B729555 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"wOpenX";
    const ASSET_NAME: vector<u8> = b"OpenX Optimism";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/wOpenX/logo.svg"), /* icon */
            utf8(b"https://openxswap.exchange"), /* project */
        );
