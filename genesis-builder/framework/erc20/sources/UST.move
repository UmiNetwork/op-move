module ERC20::xa693b19d2931d498c5b318df961919bb4aee87a5 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"UST";
    const ASSET_NAME: vector<u8> = b"UST (Wormhole)";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            6, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/UST/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
