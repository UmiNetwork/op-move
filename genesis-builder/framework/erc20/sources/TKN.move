module ERC20::x82D09e30d5D682D69B4A5d97C61b7BA651457625 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"TKN";
    const ASSET_NAME: vector<u8> = b"TokenDao";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/TKN/logo.svg"), /* icon */
            utf8(b"https://tkn.xyz"), /* project */
        );
