module ERC20::xe485E2f1bab389C08721B291f6b59780feC83Fd7 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SHU";
    const ASSET_NAME: vector<u8> = b"Shutter Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SHU/logo.svg"), /* icon */
            utf8(b"https://www.shutter.network/"), /* project */
        );
