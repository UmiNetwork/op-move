module ERC20::x71b14F197DBB6b937665C78120fC07f8355c2C2C {
    ...
    const ASSET_SYMBOL: vector<u8> = b"IDRISS";
    const ASSET_NAME: vector<u8> = b"IDRISS";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/IDRISS/logo.svg"), /* icon */
            utf8(b"https://idriss.xyz/"), /* project */
        );
