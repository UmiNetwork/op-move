module ERC20::x23894DC9da6c94ECb439911cAF7d337746575A72 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"JAM";
    const ASSET_NAME: vector<u8> = b"Geojam";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/JAM/logo.svg"), /* icon */
            utf8(b"https://www.geojam.xyz/"), /* project */
        );
