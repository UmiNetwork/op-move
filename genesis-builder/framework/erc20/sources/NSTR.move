module ERC20::x610dBd98A28EbbA525e9926b6aaF88f9159edbfd {
    ...
    const ASSET_SYMBOL: vector<u8> = b"NSTR";
    const ASSET_NAME: vector<u8> = b"Nostra";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/NSTR/logo.svg"), /* icon */
            utf8(b"https://nostra.finance/"), /* project */
        );
