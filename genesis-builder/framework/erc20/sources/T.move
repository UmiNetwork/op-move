module ERC20::xCdF7028ceAB81fA0C6971208e83fa7872994beE5 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"T";
    const ASSET_NAME: vector<u8> = b"Threshold Network Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/T/logo.svg"), /* icon */
            utf8(b"https://threshold.network"), /* project */
        );
