module ERC20::xf1Dc500FdE233A4055e25e5BbF516372BC4F6871 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SDL";
    const ASSET_NAME: vector<u8> = b"Saddle DAO";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SDL/logo.svg"), /* icon */
            utf8(b"https://saddle.finance/"), /* project */
        );
