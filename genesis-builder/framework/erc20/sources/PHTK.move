module ERC20::x1FEE5588cb1De19c70B6aD5399152D8C643FAe7b {
    ...
    const ASSET_SYMBOL: vector<u8> = b"PHTK";
    const ASSET_NAME: vector<u8> = b"PhunToken";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/PHTK/logo.svg"), /* icon */
            utf8(b"https://phuntoken.com/"), /* project */
        );
