module ERC20::xb7109df1a93f8fe2B8162c6207C9B846C1C68090 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"MAX";
    const ASSET_NAME: vector<u8> = b"Matr1x";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/MAX/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
