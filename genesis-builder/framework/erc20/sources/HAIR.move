module ERC20::x9ce115f0341ae5dabc8b477b74e83db2018a6f42 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"HAIR";
    const ASSET_NAME: vector<u8> = b"HairDAO Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/HAIR/logo.svg"), /* icon */
            utf8(b"https://www.hairdao.xyz"), /* project */
        );
