module ERC20::x321c2fe4446c7c963dc41dd58879af648838f98d {
    ...
    const ASSET_SYMBOL: vector<u8> = b"CTX";
    const ASSET_NAME: vector<u8> = b"Cryptex";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/CTX/logo.svg"), /* icon */
            utf8(b"https://cryptex.finance/"), /* project */
        );
