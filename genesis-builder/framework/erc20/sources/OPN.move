module ERC20::xc28eb2250d1AE32c7E74CFb6d6b86afC9BEb6509 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"OPN";
    const ASSET_NAME: vector<u8> = b"Open Ecosystem Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/OPN/logo.svg"), /* icon */
            utf8(b"https://onopen.xyz/"), /* project */
        );
