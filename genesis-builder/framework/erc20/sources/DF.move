module ERC20::x431ad2ff6a9C365805eBaD47Ee021148d6f7DBe0 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"DF";
    const ASSET_NAME: vector<u8> = b"dForce";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/DF/logo.svg"), /* icon */
            utf8(b"https://dforce.network"), /* project */
        );
