module ERC20::x21BfBDa47A0B4B5b1248c767Ee49F7caA9B23697 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"OVR";
    const ASSET_NAME: vector<u8> = b"OVR";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/OVR/logo.svg"), /* icon */
            utf8(b"https://overthereality.ai/"), /* project */
        );
