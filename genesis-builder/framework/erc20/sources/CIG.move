module ERC20::xCB56b52316041A62B6b5D0583DcE4A8AE7a3C629 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"CIG";
    const ASSET_NAME: vector<u8> = b"Cigarette Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/CIG/logo.svg"), /* icon */
            utf8(b"https://cigtoken.eth.limo"), /* project */
        );
