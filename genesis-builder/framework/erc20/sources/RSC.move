module ERC20::xd101dcc414f310268c37eeb4cd376ccfa507f571 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"RSC";
    const ASSET_NAME: vector<u8> = b"ResearchCoin";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/RSC/logo.svg"), /* icon */
            utf8(b"https://www.researchhub.com/"), /* project */
        );
