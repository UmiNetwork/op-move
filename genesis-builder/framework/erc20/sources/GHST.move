module ERC20::x3f382dbd960e3a9bbceae22651e88158d2791550 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"GHST";
    const ASSET_NAME: vector<u8> = b"Aavegotchi GHST Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/GHST/logo.svg"), /* icon */
            utf8(b"https://aavegotchi.com"), /* project */
        );
