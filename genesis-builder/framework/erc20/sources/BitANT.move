module ERC20::x15Ee120fD69BEc86C1d38502299af7366a41D1a6 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"BitANT";
    const ASSET_NAME: vector<u8> = b"BitANT";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/BitANT/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
