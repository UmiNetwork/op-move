module ERC20::x97D0CfEB4FdE54B430307c9482d6f79C761Fe9B6 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"EPOCH";
    const ASSET_NAME: vector<u8> = b"Epoch";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/EPOCH/logo.svg"), /* icon */
            utf8(b"https://epochisland.io/"), /* project */
        );
