module ERC20::xec463D00aa4dA76fb112cD2e4AC1C6BeF02da6ea {
    ...
    const ASSET_SYMBOL: vector<u8> = b"HEU";
    const ASSET_NAME: vector<u8> = b"Heurist";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/HEU/logo.svg"), /* icon */
            utf8(b"https://www.heurist.ai"), /* project */
        );
