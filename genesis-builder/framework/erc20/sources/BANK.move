module ERC20::x2d94aa3e47d9d5024503ca8491fce9a2fb4da198 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"BANK";
    const ASSET_NAME: vector<u8> = b"Bankless Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/BANK/logo.svg"), /* icon */
            utf8(b"https://bankless.community/"), /* project */
        );
