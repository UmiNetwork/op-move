module ERC20::x1da87b114f35e1dc91f72bf57fc07a768ad40bb0 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"EQZ";
    const ASSET_NAME: vector<u8> = b"Equalizer";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/EQZ/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
