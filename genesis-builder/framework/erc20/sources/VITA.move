module ERC20::x81f8f0bb1cB2A06649E51913A151F0E7Ef6FA321 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"VITA";
    const ASSET_NAME: vector<u8> = b"VitaDAO Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/VITA/logo.svg"), /* icon */
            utf8(b"https://www.vitadao.com"), /* project */
        );
