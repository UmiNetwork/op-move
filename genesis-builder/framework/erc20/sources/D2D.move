module ERC20::x43D4A3cd90ddD2F8f4f693170C9c8098163502ad {
    ...
    const ASSET_SYMBOL: vector<u8> = b"D2D";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/D2D/logo.svg"), /* icon */
            utf8(b"https://www.prime.xyz/"), /* project */
        );
