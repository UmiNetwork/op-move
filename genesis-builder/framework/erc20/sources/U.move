module ERC20::xcF7801cEf3e91a7e366cf77Ed3d0B6439bB34766 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"U";
    const ASSET_NAME: vector<u8> = b"U-Coin";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/U/logo.svg"), /* icon */
            utf8(b"https://u-topia.com/u-coin"), /* project */
        );
