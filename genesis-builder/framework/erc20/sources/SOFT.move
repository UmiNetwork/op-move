module ERC20::xfe3b138879d6d0555be4132dcfe6e7424e257a2e {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SOFT";
    const ASSET_NAME: vector<u8> = b"SoftDAO";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SOFT/logo.svg"), /* icon */
            utf8(b"https://softdao.ch"), /* project */
        );
