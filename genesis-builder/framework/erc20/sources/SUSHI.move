module ERC20::x6B3595068778DD592e39A122f4f5a5cF09C90fE2 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SUSHI";
    const ASSET_NAME: vector<u8> = b"SushiToken";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SUSHI/logo.svg"), /* icon */
            utf8(b"https://www.sushi.com/"), /* project */
        );
