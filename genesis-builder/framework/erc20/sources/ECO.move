module ERC20::x8dBF9A4c99580fC7Fd4024ee08f3994420035727 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"ECO";
    const ASSET_NAME: vector<u8> = b"Eco";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/ECO/logo.svg"), /* icon */
            utf8(b"https://eco.org/"), /* project */
        );
