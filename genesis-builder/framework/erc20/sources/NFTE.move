module ERC20::x8c223a82e07fecb49d602150d7c2b3a4c9630310 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"NFTE";
    const ASSET_NAME: vector<u8> = b"NFTEarthOFT";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/NFTE/logo.svg"), /* icon */
            utf8(b"https://nftearth.exchange"), /* project */
        );
