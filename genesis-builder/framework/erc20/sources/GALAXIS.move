module ERC20::x423071774C43c0Aaf4210b439E7CDA8c797e2F26 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"GALAXIS";
    const ASSET_NAME: vector<u8> = b"GALAXIS Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/GALAXIS/logo.svg"), /* icon */
            utf8(b"https://galaxis.xyz/"), /* project */
        );
