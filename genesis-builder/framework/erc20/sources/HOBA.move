module ERC20::x25cbb21a9da7c3c63bb77ccca5b2e2482aedb710 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"HOBA";
    const ASSET_NAME: vector<u8> = b"Honey Badger";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            9, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/HOBA/logo.svg"), /* icon */
            utf8(b"https://hbdc.tech/"), /* project */
        );
