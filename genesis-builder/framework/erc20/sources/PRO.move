module ERC20::x226bb599a12C826476e3A771454697EA52E9E220 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"PRO";
    const ASSET_NAME: vector<u8> = b"Propy";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            8, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/PRO/logo.svg"), /* icon */
            utf8(b"https://propy.com"), /* project */
        );
