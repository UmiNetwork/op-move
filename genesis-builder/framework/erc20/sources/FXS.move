module ERC20::x3432B6A60D23Ca0dFCa7761B7ab56459D9C964D0 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"FXS";
    const ASSET_NAME: vector<u8> = b"FXS";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/FXS/logo.svg"), /* icon */
