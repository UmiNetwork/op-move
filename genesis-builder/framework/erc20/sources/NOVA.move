module ERC20::x82967568A57625675b260Ebab1294038C9ACcC6e {
    ...
    const ASSET_SYMBOL: vector<u8> = b"NOVA";
    const ASSET_NAME: vector<u8> = b"Nova DAO";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/NOVA/logo.svg"), /* icon */
            utf8(b"https://novadao.io"), /* project */
        );
