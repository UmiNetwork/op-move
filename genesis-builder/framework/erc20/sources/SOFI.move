module ERC20::xB49fa25978abf9a248b8212Ab4b87277682301c0 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SOFI";
    const ASSET_NAME: vector<u8> = b"Rai.Finance";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SOFI/logo.svg"), /* icon */
            utf8(b"https://rai.finance/"), /* project */
        );
