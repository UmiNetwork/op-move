module ERC20::xc5102fe9359fd9a28f877a67e36b0f050d81a3cc {
    ...
    const ASSET_SYMBOL: vector<u8> = b"HOP";
    const ASSET_NAME: vector<u8> = b"Hop";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/HOP/logo.svg"), /* icon */
            utf8(b"https://hop.exchange"), /* project */
        );
