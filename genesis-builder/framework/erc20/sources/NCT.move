module ERC20::x9E46A38F5DaaBe8683E10793b06749EEF7D733d1 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"NCT";
    const ASSET_NAME: vector<u8> = b"PolySwarm";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/NCT/logo.svg"), /* icon */
            utf8(b"https://polyswarm.io"), /* project */
        );
