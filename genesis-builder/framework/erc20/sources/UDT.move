module ERC20::x90DE74265a416e1393A450752175AED98fe11517 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"UDT";
    const ASSET_NAME: vector<u8> = b"Unlock Discount Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/UDT/logo.svg"), /* icon */
            utf8(b"https://unlock-protocol.com"), /* project */
        );
