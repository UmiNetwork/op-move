module ERC20::x8947da500Eb47F82df21143D0C01A29862a8C3c5 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"THALES";
    const ASSET_NAME: vector<u8> = b"Optimistic Thales Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/THALES/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
