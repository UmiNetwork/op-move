module ERC20::xB90B2A35C65dBC466b04240097Ca756ad2005295 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"BOBO";
    const ASSET_NAME: vector<u8> = b"BOBO";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/BOBO/logo.svg"), /* icon */
            utf8(b"https://bobothebear.io"), /* project */
        );
