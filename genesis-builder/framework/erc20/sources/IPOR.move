module ERC20::x1e4746dC744503b53b4A082cB3607B169a289090 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"IPOR";
    const ASSET_NAME: vector<u8> = b"IPOR Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/IPOR/logo.svg"), /* icon */
            utf8(b"https://ipor.io"), /* project */
        );
