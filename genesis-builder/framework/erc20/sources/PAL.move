module ERC20::xAB846Fb6C81370327e784Ae7CbB6d6a6af6Ff4BF {
    ...
    const ASSET_SYMBOL: vector<u8> = b"PAL";
    const ASSET_NAME: vector<u8> = b"Paladin Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/PAL/logo.svg"), /* icon */
            utf8(b"https://paladin.vote"), /* project */
        );
