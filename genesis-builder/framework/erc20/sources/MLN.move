module ERC20::xec67005c4E498Ec7f55E092bd1d35cbC47C91892 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"MLN";
    const ASSET_NAME: vector<u8> = b"Melon Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/MLN/logo.svg"), /* icon */
            utf8(b"https://enzyme.finance"), /* project */
        );
