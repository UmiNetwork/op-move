module ERC20::x5Ca135cB8527d76e932f34B5145575F9d8cbE08E {
    ...
    const ASSET_SYMBOL: vector<u8> = b"FPI";
    const ASSET_NAME: vector<u8> = b"Frax Price Index";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/FPI/logo.svg"), /* icon */
