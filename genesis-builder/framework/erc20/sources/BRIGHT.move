module ERC20::x5dd57da40e6866c9fcc34f4b6ddc89f1ba740dfe {
    ...
    const ASSET_SYMBOL: vector<u8> = b"BRIGHT";
    const ASSET_NAME: vector<u8> = b"Bright";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/BRIGHT/logo.svg"), /* icon */
            utf8(b"https://dao.brightid.org"), /* project */
        );
