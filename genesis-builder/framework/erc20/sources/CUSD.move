module ERC20::x0b6A24A288eF6e1bFFd94EBe0EE026D80Cb4cE82 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"CUSD";
    const ASSET_NAME: vector<u8> = b"Chad USD";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/CUSD/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
