module ERC20::x76A0e27618462bDAC7a29104bdcfFf4E6BFCea2D {
    use ERC20::base::Self;
    use aptos_framework::object::Object;
    use aptos_framework::fungible_asset_u256::Metadata;

    const ASSET_SYMBOL: vector<u8> = b"SOSO";
    const ASSET_NAME: vector<u8> = b"SoSoValue";
    ...
    fun init_module(admin: &signer) {
        let metadata = base::create_token_metadata(
            ...
            ASSET_NAME,
            18,
            b"https://ethereum-optimism.github.io/data/SOSO/logo.svg",
            b"https://www.sosovalue.com/",
        );
