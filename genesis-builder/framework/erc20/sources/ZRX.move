module ERC20::xE41d2489571d322189246DaFA5ebDe1F4699F498 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"ZRX";
    const ASSET_NAME: vector<u8> = b"0x Protocol Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/ZRX/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
