module ERC20::x6982508145454Ce325dDbE47a25d4ec3d2311933 {
    ...
    const ASSET_NAME: vector<u8> = b"Pepe";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/PEPE/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
