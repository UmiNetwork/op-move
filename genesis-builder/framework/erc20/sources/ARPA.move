module ERC20::xBA50933C268F567BDC86E1aC131BE072C6B0b71a {
    ...
    const ASSET_SYMBOL: vector<u8> = b"ARPA";
    const ASSET_NAME: vector<u8> = b"ARPA Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/ARPA/logo.svg"), /* icon */
            utf8(b"https://www.arpanetwork.io"), /* project */
        );
