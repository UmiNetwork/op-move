module ERC20::xfE80D611c6403f70e5B1b9B722D2B3510B740B2B {
    ...
    const ASSET_SYMBOL: vector<u8> = b"EQB";
    const ASSET_NAME: vector<u8> = b"Equilibria Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/EQB/logo.svg"), /* icon */
