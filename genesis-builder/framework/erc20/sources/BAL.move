module ERC20::xba100000625a3754423978a60c9317c58a424e3D {
    ...
    const ASSET_SYMBOL: vector<u8> = b"BAL";
    const ASSET_NAME: vector<u8> = b"Balancer";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/BAL/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
