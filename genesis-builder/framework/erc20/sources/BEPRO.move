module ERC20::xCF3C8Be2e2C42331Da80EF210e9B1b307C03d36A {
    ...
    const ASSET_SYMBOL: vector<u8> = b"BEPRO";
    const ASSET_NAME: vector<u8> = b"Bepro Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/BEPRO/logo.svg"), /* icon */
            utf8(b"https://bepro.network"), /* project */
        );
