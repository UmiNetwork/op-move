module ERC20::x3593D125a4f7849a1B059E64F4517A86Dd60c95d {
    ...
    const ASSET_SYMBOL: vector<u8> = b"OM";
    const ASSET_NAME: vector<u8> = b"MANTRA DAO";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/OM/logo.svg"), /* icon */
            utf8(b"https://www.mantrachain.io/"), /* project */
        );
