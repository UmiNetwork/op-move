module ERC20::x677ddbd918637E5F2c79e164D402454dE7dA8619 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"VUSD";
    const ASSET_NAME: vector<u8> = b"VUSD";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/VUSD/logo.svg"), /* icon */
            utf8(b"https://vdollar.finance/"), /* project */
        );
