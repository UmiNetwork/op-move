module ERC20::xD38e031f4529a07996aaB977d2B79f0e00656C56 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"wTBT";
    const ASSET_NAME: vector<u8> = b"wTBT Pool";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/wTBT/logo.svg"), /* icon */
            utf8(b"https://tprotocol.io/"), /* project */
        );
