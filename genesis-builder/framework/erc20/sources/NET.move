module ERC20::x6e6b7adfc7db9feeb8896418ac3422966f65d0a5 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"NET";
    const ASSET_NAME: vector<u8> = b"Nektar Network";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/NET/logo.svg"), /* icon */
            utf8(b"https://nektar.network/"), /* project */
        );
