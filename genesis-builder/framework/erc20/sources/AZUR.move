module ERC20::x9E6be44cC1236eEf7e1f197418592D363BedCd5A {
    ...
    const ASSET_SYMBOL: vector<u8> = b"AZUR";
    const ASSET_NAME: vector<u8> = b"Azuro";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/AZUR/logo.svg"), /* icon */
            utf8(b"https://azuro.org/"), /* project */
        );
