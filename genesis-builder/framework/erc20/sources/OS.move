module ERC20::x6100dd79fCAA88420750DceE3F735d168aBcB771 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"OS";
    const ASSET_NAME: vector<u8> = b"Ethereans";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/OS/logo.svg"), /* icon */
            utf8(b"https://ethereans.app"), /* project */
        );
