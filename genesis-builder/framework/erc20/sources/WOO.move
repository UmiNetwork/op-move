module ERC20::x4691937a7508860F876c9c0a2a617E7d9E945D4B {
    ...
    const ASSET_SYMBOL: vector<u8> = b"WOO";
    const ASSET_NAME: vector<u8> = b"Wootrade Network";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/WOO/logo.svg"), /* icon */
            utf8(b"https://woo.network"), /* project */
        );
