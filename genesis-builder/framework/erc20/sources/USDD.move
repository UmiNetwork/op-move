module ERC20::x0C10bF8FcB7Bf5412187A595ab97a3609160b5c6 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"USDD";
    const ASSET_NAME: vector<u8> = b"Decentralized USD";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/USDD/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
