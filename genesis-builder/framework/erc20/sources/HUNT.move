module ERC20::x9AAb071B4129B083B01cB5A0Cb513Ce7ecA26fa5 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"HUNT";
    const ASSET_NAME: vector<u8> = b"HuntToken";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/HUNT/logo.svg"), /* icon */
            utf8(b"https://hunt.town"), /* project */
        );
