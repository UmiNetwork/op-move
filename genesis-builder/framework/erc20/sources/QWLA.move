module ERC20::x1D96Fd43EE07Aa79f8Fd003cbdF404fb5ce41AD2 {
    use ERC20::base::Self;
    use aptos_framework::object::Object;
    use aptos_framework::fungible_asset_u256::Metadata;

    const ASSET_SYMBOL: vector<u8> = b"QWLA";
    const ASSET_NAME: vector<u8> = b"Qawalla Token";
    ...
    fun init_module(admin: &signer) {
        let metadata = base::create_token_metadata(
            ...
            ASSET_NAME,
            18,
            b"https://ethereum-optimism.github.io/data/QWLA/logo.svg",
            b"https://qwla.io",
        );
