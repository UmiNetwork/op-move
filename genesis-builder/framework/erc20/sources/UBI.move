module ERC20::xDd1Ad9A21Ce722C151A836373baBe42c868cE9a4 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"UBI";
    const ASSET_NAME: vector<u8> = b"Universal Basic Income";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/UBI/logo.svg"), /* icon */
            utf8(b"https://ubi.eth.limo"), /* project */
        );
