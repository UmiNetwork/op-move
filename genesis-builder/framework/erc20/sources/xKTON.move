module ERC20::x35f15275041B53324dF461d5ccC952EE19D4a982 {
    use ERC20::base::Self;
    use aptos_framework::object::Object;
    use aptos_framework::fungible_asset_u256::Metadata;

    const ASSET_SYMBOL: vector<u8> = b"xKTON";
    const ASSET_NAME: vector<u8> = b"Darwinia Commitment xKTON";
    ...
    fun init_module(admin: &signer) {
        let metadata = base::create_token_metadata(
            ...
            ASSET_NAME,
            18,
            b"https://ethereum-optimism.github.io/data/XKTON/logo.svg",
            b"https://ktondao.xyz",
        );
