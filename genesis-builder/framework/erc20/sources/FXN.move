module ERC20::x365AccFCa291e7D3914637ABf1F7635dB165Bb09 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"FXN";
    const ASSET_NAME: vector<u8> = b"FXN Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/FXN/logo.svg"), /* icon */
