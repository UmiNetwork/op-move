module ERC20::xFc169284da39e8d337D01AB011C3e5d92f7DDBa6 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"RIZE";
    const ASSET_NAME: vector<u8> = b"GenRize";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/RIZE/logo.svg"), /* icon */
            utf8(b"https://genrize.io"), /* project */
        );
