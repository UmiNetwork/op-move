module ERC20::x42EDBbA2f54e1E765235A81Bd416F1DA89Dc8540 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"YOKAI";
    const ASSET_NAME: vector<u8> = b"YokAI: Generative Monsters";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/YOKAI/logo.svg"), /* icon */
            utf8(b"https://yokai.game"), /* project */
        );
