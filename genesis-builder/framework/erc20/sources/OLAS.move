module ERC20::x0001A500A6B18995B03f44bb040A5fFc28E45CB0 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"OLAS";
    const ASSET_NAME: vector<u8> = b"Autonolas";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/OLAS/logo.svg"), /* icon */
            utf8(b"https://olas.network"), /* project */
        );
