module ERC20::xA4fFdf3208F46898CE063e25c1C43056FA754739 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"ATH";
    const ASSET_NAME: vector<u8> = b"AthenaDAO Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/ATH/logo.svg"), /* icon */
            utf8(b"https://www.athenadao.co/"), /* project */
        );
