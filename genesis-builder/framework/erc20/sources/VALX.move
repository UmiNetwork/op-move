module ERC20::x27C4af9A860c4caDc358005F8b48140b2E434A7B {
    ...
    const ASSET_SYMBOL: vector<u8> = b"VALX";
    const ASSET_NAME: vector<u8> = b"Validator";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/VALX/logo.svg"), /* icon */
            utf8(b"https://valix.org/"), /* project */
        );
