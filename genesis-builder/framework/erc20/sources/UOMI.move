module ERC20::x6b4BCfeCcf80AB79EAE40475af34Cd986e583090 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"UOMI";
    const ASSET_NAME: vector<u8> = b"UOMI";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/UOMI/logo.svg"), /* icon */
            utf8(b"https://uomi.ai/"), /* project */
        );
