module ERC20::x48afbbd342f64ef8a9ab1c143719b63c2ad81710 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"mpETH";
    const ASSET_NAME: vector<u8> = b"MetaPoolETH";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/mpETH/logo.svg"), /* icon */
            utf8(b"https://www.metapool.app/"), /* project */
        );
