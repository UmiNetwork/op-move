module ERC20::x8457CA5040ad67fdebbCC8EdCE889A335Bc0fbFB {
    ...
    const ASSET_SYMBOL: vector<u8> = b"ALT";
    const ASSET_NAME: vector<u8> = b"AltLayer";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/ALT/logo.svg"), /* icon */
            utf8(b"https://altlayer.io/"), /* project */
        );
