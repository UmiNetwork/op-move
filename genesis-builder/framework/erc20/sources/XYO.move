module ERC20::x55296f69f40ea6d20e478533c15a6b08b654e758 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"XYO";
    const ASSET_NAME: vector<u8> = b"XY Oracle";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/XYO/logo.svg"), /* icon */
            utf8(b"https://xyo.network"), /* project */
        );
