module ERC20::x7697b462a7c4ff5f8b55bdbc2f4076c2af9cf51a {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SARCO";
    const ASSET_NAME: vector<u8> = b"Sarcophagus";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SARCO/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
