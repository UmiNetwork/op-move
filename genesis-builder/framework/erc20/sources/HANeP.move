module ERC20::x5052fa4a2a147eaAa4c0242e9Cc54a10A4f42070 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"HANeP";
    const ASSET_NAME: vector<u8> = b"HANePlatform";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/HANeP/logo.svg"), /* icon */
            utf8(b"https://hanep.io"), /* project */
        );
