module ERC20::xC1f33e0cf7e40a67375007104B929E49a581bafE {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SPOT";
    const ASSET_NAME: vector<u8> = b"SPOT";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            9, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SPOT/logo.svg"), /* icon */
            utf8(b"https://spot.cash"), /* project */
        );
