module ERC20::x6b66ccd1340c479B07B390d326eaDCbb84E726Ba {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SEAM";
    const ASSET_NAME: vector<u8> = b"Seamless";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SEAM/logo.svg"), /* icon */
            utf8(b"https://www.seamlessprotocol.com"), /* project */
        );
