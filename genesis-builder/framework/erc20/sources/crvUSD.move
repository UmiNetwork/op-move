module ERC20::xf939E0A03FB07F59A73314E73794Be0E57ac1b4E {
    ...
    const ASSET_SYMBOL: vector<u8> = b"crvUSD";
    const ASSET_NAME: vector<u8> = b"Curve.Fi USD Stablecoin";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/crvUSD/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
