module ERC20::xAF4144cd943ed5362Fed2BaE6573184659CBe6FF {
    ...
    const ASSET_SYMBOL: vector<u8> = b"LIZ";
    const ASSET_NAME: vector<u8> = b"Lizcoin";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/LIZCOIN/logo.svg"), /* icon */
            utf8(b"https://lizlabs.io/"), /* project */
        );
