module ERC20::x7c8E7A5CA7c6EdCEc00B6bF12DA207AEe4Af5513 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"wHOGE";
    const ASSET_NAME: vector<u8> = b"Wrapped HOGE";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            9, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/wHOGE/logo.svg"), /* icon */
            utf8(b"https://www.hogefinance.net"), /* project */
        );
