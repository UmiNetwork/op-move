module ERC20::xab814ce69E15F6B9660A3B184c0B0C97B9394A6b {
    ...
    const ASSET_SYMBOL: vector<u8> = b"NEURON";
    const ASSET_NAME: vector<u8> = b"Cerebrum DAO Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/NEURON/logo.svg"), /* icon */
            utf8(b"https://www.cerebrumdao.com/"), /* project */
        );
