module ERC20::xf2051511B9b121394FA75B8F7d4E7424337af687 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"HAUS";
    const ASSET_NAME: vector<u8> = b"DAOhaus Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/HAUS/logo.svg"), /* icon */
            utf8(b"https://daohaus.club/"), /* project */
        );
