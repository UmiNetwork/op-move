module ERC20::x808507121B80c02388fAd14726482e061B8da827 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"PENDLE";
    const ASSET_NAME: vector<u8> = b"Pendle";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/PENDLE/logo.svg"), /* icon */
            utf8(b"https://pendle.finance/"), /* project */
        );
