module ERC20::x0763fdccf1ae541a5961815c0872a8c5bc6de4d7 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SUKU";
    const ASSET_NAME: vector<u8> = b"SUKU";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SUKU/logo.svg"), /* icon */
            utf8(b"https://www.suku.world/"), /* project */
        );
