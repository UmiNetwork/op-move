module ERC20::xb31ef9e52d94d4120eb44fe1ddfde5b4654a6515 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"DOSE";
    const ASSET_NAME: vector<u8> = b"DOSE";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/DOSE/logo.svg"), /* icon */
            utf8(b"https://www.dosetoken.com/"), /* project */
        );
