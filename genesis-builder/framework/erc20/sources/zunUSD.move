module ERC20::x8C0D76C9B18779665475F3E212D9Ca1Ed6A1A0e6 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"zunUSD";
    const ASSET_NAME: vector<u8> = b"Zunami USD";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/zunUSD/logo.svg"), /* icon */
