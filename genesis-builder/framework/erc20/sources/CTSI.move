module ERC20::x491604c0FDF08347Dd1fa4Ee062a822A5DD06B5D {
    ...
    const ASSET_SYMBOL: vector<u8> = b"CTSI";
    const ASSET_NAME: vector<u8> = b"Cartesi Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/CTSI/logo.svg"), /* icon */
            utf8(b"https://cartesi.io/"), /* project */
        );
