module ERC20::x906c012fa4C30d580537c2b72d1789F56F488a80 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"POGS";
    const ASSET_NAME: vector<u8> = b"PogCoin";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/POGS/logo.svg"), /* icon */
            utf8(b"https://www.pogdigital.com/"), /* project */
        );
