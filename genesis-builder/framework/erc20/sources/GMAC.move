module ERC20::xD96e84DDBc7CbE1D73c55B6fe8c64f3a6550deea {
    ...
    const ASSET_SYMBOL: vector<u8> = b"GMAC";
    const ASSET_NAME: vector<u8> = b"Gemach";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/GMAC/logo.svg"), /* icon */
            utf8(b"https://gemach.io"), /* project */
        );
