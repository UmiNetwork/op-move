module ERC20::x467Bccd9d29f223BcE8043b84E8C8B282827790F {
    ...
    const ASSET_SYMBOL: vector<u8> = b"TEL";
    const ASSET_NAME: vector<u8> = b"Telcoin";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            2, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/TEL/logo.svg"), /* icon */
            utf8(b"https://www.telco.in"), /* project */
        );
