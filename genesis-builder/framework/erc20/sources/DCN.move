module ERC20::x08d32b0da63e2C3bcF8019c9c5d849d7a9d791e6 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"DCN";
    const ASSET_NAME: vector<u8> = b"Dentacoin";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            0, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/DCN/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
