module ERC20::x5fa20d59d2a907e5fed9fb80b4a8d9f0d069a48d {
    ...
    const ASSET_SYMBOL: vector<u8> = b"NOGS";
    const ASSET_NAME: vector<u8> = b"Noggles";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/NOGS/logo.svg"), /* icon */
            utf8(b"https://noggles.com"), /* project */
        );
