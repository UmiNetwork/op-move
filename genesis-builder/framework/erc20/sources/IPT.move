module ERC20::xd909C5862Cdb164aDB949D92622082f0092eFC3d {
    ...
    const ASSET_SYMBOL: vector<u8> = b"IPT";
    const ASSET_NAME: vector<u8> = b"Interest Protocol";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/IPT/logo.svg"), /* icon */
            utf8(b"https://interestprotocol.io/"), /* project */
        );
