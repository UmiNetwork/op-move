module ERC20::xF35155E38C8750372ca024a3d1b5cc7174AaaBbC {
    ...
    const ASSET_SYMBOL: vector<u8> = b"CTRAVL";
    const ASSET_NAME: vector<u8> = b"Travel Deals";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            4, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/CTRAVL/logo.svg"), /* icon */
            utf8(b"https://cryptotraveldeals.com"), /* project */
        );
