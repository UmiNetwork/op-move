module ERC20::x0cec1a9154ff802e7934fc916ed7ca50bde6844e {
    ...
    const ASSET_SYMBOL: vector<u8> = b"POOL";
    const ASSET_NAME: vector<u8> = b"PoolTogether";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/POOL/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
