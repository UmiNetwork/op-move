module ERC20::x744d70FDBE2Ba4CF95131626614a1763DF805B9E {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SNT";
    const ASSET_NAME: vector<u8> = b"Status Network Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SNT/logo.svg"), /* icon */
            utf8(b"https://status.im/"), /* project */
        );
