module ERC20::xfF20817765cB7f73d4bde2e66e067E58D11095C2 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"AMP";
    const ASSET_NAME: vector<u8> = b"Amp";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/AMP/logo.svg"), /* icon */
            utf8(b"https://amptoken.org/"), /* project */
        );
