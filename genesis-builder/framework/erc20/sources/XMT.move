module ERC20::x3E5D9D8a63CC8a88748f229999CF59487e90721e {
    ...
    const ASSET_SYMBOL: vector<u8> = b"XMT";
    const ASSET_NAME: vector<u8> = b"MetalSwap";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/XMT/logo.svg"), /* icon */
            utf8(b"https://metalswap.finance"), /* project */
        );
