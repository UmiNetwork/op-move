module ERC20::x98933f2396DBaABf812b6E6d27dA4DF109C4c55F {
    ...
    const ASSET_SYMBOL: vector<u8> = b"TODL";
    const ASSET_NAME: vector<u8> = b"Cryptoodles Toodle Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/TODL/logo.svg"), /* icon */
            utf8(b"https://cryptoodles.com"), /* project */
        );
