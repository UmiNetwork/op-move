module ERC20::x996d67aa9b37df96428ad3608cb21352bf1fdb90 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"stZENT";
    const ASSET_NAME: vector<u8> = b"Staked Zentry";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/stZENT/logo.svg"), /* icon */
            utf8(b"https://zentry.com"), /* project */
        );
