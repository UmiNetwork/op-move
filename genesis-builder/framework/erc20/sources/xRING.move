module ERC20::x81e32d4652Be82AE225DEdd1bD0bf3BCba8FEE07 {
    use ERC20::base::Self;
    use aptos_framework::object::Object;
    use aptos_framework::fungible_asset_u256::Metadata;

    const ASSET_SYMBOL: vector<u8> = b"xRING";
    const ASSET_NAME: vector<u8> = b"Darwinia Network xRING";
    ...
    fun init_module(admin: &signer) {
        let metadata = base::create_token_metadata(
            ...
            ASSET_NAME,
            18,
            b"https://ethereum-optimism.github.io/data/XRING/logo.svg",
            b"https://darwinia.network",
        );
