module ERC20::xc011a73ee8576fb46f5e1c5751ca3b9fe0af2a6f {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SNX";
    const ASSET_NAME: vector<u8> = b"Synthetix";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SNX/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
