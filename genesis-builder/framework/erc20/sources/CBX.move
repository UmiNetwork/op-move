module ERC20::x37fc4b48ce93469dbea9918468993c735049642a {
    ...
    const ASSET_SYMBOL: vector<u8> = b"CBX";
    const ASSET_NAME: vector<u8> = b"CropBytes";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/CBX/logo.svg"), /* icon */
            utf8(b"https://www.cropbytes.com/"), /* project */
        );
