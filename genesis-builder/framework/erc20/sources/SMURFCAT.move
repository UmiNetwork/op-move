module ERC20::xfF836A5821E69066c87E268bC51b849FaB94240C {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SMURFCAT";
    const ASSET_NAME: vector<u8> = b"Real Smurf Cat";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SMURFCAT/logo.svg"), /* icon */
            utf8(b"https://smurfcat.eth.limo/"), /* project */
        );
