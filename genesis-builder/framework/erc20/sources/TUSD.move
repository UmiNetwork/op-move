module ERC20::x0000000000085d4780B73119b644AE5ecd22b376 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"TUSD";
    const ASSET_NAME: vector<u8> = b"TrueUSD";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/TUSD/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
