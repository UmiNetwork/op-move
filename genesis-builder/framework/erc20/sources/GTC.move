module ERC20::xde30da39c46104798bb5aa3fe8b9e0e1f348163f {
    ...
    const ASSET_SYMBOL: vector<u8> = b"GTC";
    const ASSET_NAME: vector<u8> = b"Gitcoin";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/GTC/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
