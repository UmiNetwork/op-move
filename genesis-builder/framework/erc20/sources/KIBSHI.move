module ERC20::x02e7F808990638E9e67E1f00313037EDe2362361 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"KIBSHI";
    const ASSET_NAME: vector<u8> = b"KiboShib";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/KIBSHI/logo.svg"), /* icon */
            utf8(b"https://kiboshib.com"), /* project */
        );
