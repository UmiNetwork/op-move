module ERC20::xc11158c5da9db1d553ed28f0c2ba1cbedd42cfcb {
    ...
    const ASSET_SYMBOL: vector<u8> = b"wPAW";
    const ASSET_NAME: vector<u8> = b"Wrapped PAW";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/WPAW/logo.svg"), /* icon */
            utf8(b"https://pawchain.net"), /* project */
        );
