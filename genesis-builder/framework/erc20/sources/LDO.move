module ERC20::x5A98FcBEA516Cf06857215779Fd812CA3beF1B32 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"LDO";
    const ASSET_NAME: vector<u8> = b"Lido DAO Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/LDO/logo.svg"), /* icon */
            utf8(b"https://lido.fi/"), /* project */
        );
