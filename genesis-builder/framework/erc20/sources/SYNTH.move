module ERC20::xd41f3d112cb8695c7a8992e4055bd273f3ce8729 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SYNTH";
    const ASSET_NAME: vector<u8> = b"Synth";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SYNTH/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
