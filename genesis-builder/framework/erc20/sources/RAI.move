module ERC20::x03ab458634910AaD20eF5f1C8ee96F1D6ac54919 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"RAI";
    const ASSET_NAME: vector<u8> = b"Rai Reflex Index";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/RAI/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
