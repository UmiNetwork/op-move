module ERC20::xf4308b0263723b121056938c2172868E408079D0 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"CRYO";
    const ASSET_NAME: vector<u8> = b"CryoDAO";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/CRYO/logo.svg"), /* icon */
            utf8(b"https://www.cryodao.org/"), /* project */
        );
