module ERC20::x111111111117dC0aa78b770fA6A738034120C302 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"1INCH";
    const ASSET_NAME: vector<u8> = b"1INCH Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/1INCH/logo.svg"), /* icon */
            utf8(b"https://1inch.io/"), /* project */
        );
