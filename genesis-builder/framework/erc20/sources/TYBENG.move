module ERC20::xd9ebbc7970e26b4eced7323b9331763e8272d011 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"TYBENG";
    const ASSET_NAME: vector<u8> = b"TYBENG";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/TYBENG/logo.svg"), /* icon */
            utf8(b"https://benjibananas.com/"), /* project */
        );
