module ERC20::xcb9f85730f57732fc899fb158164b9ed60c77d49 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"stkLYRA";
    const ASSET_NAME: vector<u8> = b"Staked Lyra";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/stkLYRA/logo.svg"), /* icon */
            utf8(b"https://www.lyra.finance/"), /* project */
        );
