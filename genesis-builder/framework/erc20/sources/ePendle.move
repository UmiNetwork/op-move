module ERC20::x22Fc5A29bd3d6CCe19a06f844019fd506fCe4455 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"ePendle";
    const ASSET_NAME: vector<u8> = b"Equilibria Pendle";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/ePENDLE/logo.svg"), /* icon */
            utf8(b"https://equilibria.fi/"), /* project */
        );
