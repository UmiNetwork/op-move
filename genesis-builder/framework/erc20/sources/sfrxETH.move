module ERC20::xac3E018457B222d93114458476f3E3416Abbe38F {
    ...
    const ASSET_SYMBOL: vector<u8> = b"sfrxETH";
    const ASSET_NAME: vector<u8> = b"Staked Frax Ether";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/sfrxETH/logo.svg"), /* icon */
            utf8(b"https://frax.finance/"), /* project */
        );
