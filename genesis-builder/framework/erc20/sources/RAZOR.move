module ERC20::x50de6856358cc35f3a9a57eaaa34bd4cb707d2cd {
    ...
    const ASSET_SYMBOL: vector<u8> = b"RAZOR";
    const ASSET_NAME: vector<u8> = b"RAZOR";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/RAZOR/logo.svg"), /* icon */
            utf8(b"https://razor.network"), /* project */
        );
