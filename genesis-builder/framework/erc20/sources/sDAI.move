module ERC20::x83F20F44975D03b1b09e64809B757c47f942BEeA {
    ...
    const ASSET_SYMBOL: vector<u8> = b"sDAI";
    const ASSET_NAME: vector<u8> = b"Savings Dai";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/sDAI/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
