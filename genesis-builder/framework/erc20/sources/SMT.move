module ERC20::xB17548c7B510427baAc4e267BEa62e800b247173 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SMT";
    const ASSET_NAME: vector<u8> = b"Swarm Markets";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SMT/logo.svg"), /* icon */
            utf8(b"https://swarm.com"), /* project */
        );
