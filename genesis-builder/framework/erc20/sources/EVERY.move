module ERC20::x9aFa9999e45484Adf5d8EED8D9Dfe0693BACd838 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"EVERY";
    const ASSET_NAME: vector<u8> = b"Everyworld";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/EVERY/logo.svg"), /* icon */
            utf8(b"https://www.everyworld.com/"), /* project */
        );
