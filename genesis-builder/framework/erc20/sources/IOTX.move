module ERC20::x6fB3e0A217407EFFf7Ca062D46c26E5d60a14d69 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"IOTX";
    const ASSET_NAME: vector<u8> = b"IoTeX Network";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/IOTX/logo.svg"), /* icon */
            utf8(b"http://iotex.io/"), /* project */
        );
