module ERC20::xF5a893Cc9b09c46FDAeCE4301Abc88C5c9C926C2 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"AVC";
    const ASSET_NAME: vector<u8> = b"Animalverse Club";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/AVC/logo.svg"), /* icon */
            utf8(b"https://animalverse.club"), /* project */
        );
