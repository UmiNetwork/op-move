module ERC20::x1B1FF83AE0751ffb7ce0224e9C330e859E95dD16 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"LEGEND";
    const ASSET_NAME: vector<u8> = b"Legend";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/LEGEND/logo.svg"), /* icon */
            utf8(b"https://www.belegends.com/"), /* project */
        );
