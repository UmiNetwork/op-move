module ERC20::xf31698DDAd0d11160Fe85c500397A470CD3d492E {
    ...
    const ASSET_SYMBOL: vector<u8> = b"WEXO";
    const ASSET_NAME: vector<u8> = b"WEXO";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/WEXO/logo.svg"), /* icon */
            utf8(b"https://wexopay.com"), /* project */
        );
