module ERC20::xdBB7a34Bf10169d6d2D0d02A6cbb436cF4381BFa {
    ...
    const ASSET_SYMBOL: vector<u8> = b"ZENT";
    const ASSET_NAME: vector<u8> = b"Zentry";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/ZENT/logo.svg"), /* icon */
