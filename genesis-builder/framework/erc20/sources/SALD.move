module ERC20::x5582a479f0c403e207d2578963ccef5d03ba636f {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SALD";
    const ASSET_NAME: vector<u8> = b"Salad";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SALD/logo.svg"), /* icon */
            utf8(b"https://salad.ventures"), /* project */
        );
