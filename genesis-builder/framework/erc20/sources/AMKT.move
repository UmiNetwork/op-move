module ERC20::xF17A3fE536F8F7847F1385ec1bC967b2Ca9caE8D {
    ...
    const ASSET_SYMBOL: vector<u8> = b"AMKT";
    const ASSET_NAME: vector<u8> = b"Alongside Crypto Market Index";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/AMKT/logo.svg"), /* icon */
            utf8(b"https://www.alongside.xyz"), /* project */
        );
