module ERC20::xbaac2b4491727d78d2b78815144570b9f2fe8899 {
    ...
    const ASSET_NAME: vector<u8> = b"The Doge NFT";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/DOG/logo.svg"), /* icon */
            utf8(b"https://www.ownthedoge.com"), /* project */
        );
