module ERC20::x8207c1ffc5b6804f6024322ccf34f29c3541ae26 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"OGN";
    const ASSET_NAME: vector<u8> = b"OriginToken";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/OGN/logo.svg"), /* icon */
            utf8(b"https://www.originprotocol.com/"), /* project */
        );
