module ERC20::xe1eb70B51C87e927d1a823Dbd478C27AB0F777F1 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"DRODEC";
    const ASSET_NAME: vector<u8> = b"DRODEC";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/DRODEC/logo.svg"), /* icon */
            utf8(b"https://defli.network/drone-detection-host"), /* project */
        );
