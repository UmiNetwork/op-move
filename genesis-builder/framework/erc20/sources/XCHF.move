module ERC20::xB4272071eCAdd69d933AdcD19cA99fe80664fc08 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"XCHF";
    const ASSET_NAME: vector<u8> = b"CryptoFranc";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/XCHF/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
