module ERC20::x6dea81c8171d0ba574754ef6f8b412f2ed88c54d {
    ...
    const ASSET_SYMBOL: vector<u8> = b"LQTY";
    const ASSET_NAME: vector<u8> = b"LQTY";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/LQTY/logo.svg"), /* icon */
            utf8(b"https://liquity.org/"), /* project */
        );
