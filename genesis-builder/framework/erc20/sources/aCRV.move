module ERC20::x2b95a1dcc3d405535f9ed33c219ab38e8d7e0884 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"aCRV";
    const ASSET_NAME: vector<u8> = b"AladdinCRV";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/aCRV/logo.svg"), /* icon */
            utf8(b"https://concentrator.aladdin.club/"), /* project */
        );
