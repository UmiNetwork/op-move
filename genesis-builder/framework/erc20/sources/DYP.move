module ERC20::x39b46B212bDF15b42B166779b9d1787A68b9D0c3 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"DYP";
    const ASSET_NAME: vector<u8> = b"Dypius";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/DYP/logo.svg"), /* icon */
            utf8(b"https://www.dypius.com"), /* project */
        );
