module ERC20::x0D505C03d30e65f6e9b4Ef88855a47a89e4b7676 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"ZOOMER";
    const ASSET_NAME: vector<u8> = b"ZoomerCoin";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/ZOOMER/logo.svg"), /* icon */
            utf8(b"https://zoomer.money"), /* project */
        );
