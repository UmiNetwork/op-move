module ERC20::xaaee1a9723aadb7afa2810263653a34ba2c21c7a {
    ...
    const ASSET_SYMBOL: vector<u8> = b"Mog";
    const ASSET_NAME: vector<u8> = b"Mog Coin";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/MOG/logo.svg"), /* icon */
            utf8(b"https://mogcoin.xyz/"), /* project */
        );
