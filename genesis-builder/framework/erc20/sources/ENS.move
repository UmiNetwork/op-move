module ERC20::xc18360217d8f7ab5e7c516566761ea12ce7f9d72 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"ENS";
    const ASSET_NAME: vector<u8> = b"Ethereum Name Service";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/ENS/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
