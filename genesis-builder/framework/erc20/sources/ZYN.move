module ERC20::x58cB30368ceB2d194740b144EAB4c2da8a917Dcb {
    ...
    const ASSET_SYMBOL: vector<u8> = b"ZYN";
    const ASSET_NAME: vector<u8> = b"ZynCoin";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/ZYN/logo.svg"), /* icon */
            utf8(b"https://www.zyncoin.io/"), /* project */
        );
