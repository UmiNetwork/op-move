module ERC20::xa80505c408C4DEFD9522981cD77e026f5a49FE63 {
    use ERC20::base::Self;
    use aptos_framework::object::Object;
    use aptos_framework::fungible_asset_u256::Metadata;

    const ASSET_SYMBOL: vector<u8> = b"NEUY";
    const ASSET_NAME: vector<u8> = b"NEUY";
    ...
    fun init_module(admin: &signer) {
        let metadata = base::create_token_metadata(
            ...
            ASSET_NAME,
            18,
            b"https://ethereum-optimism.github.io/data/NEUY/logo.svg",
            b"https://neuy.io/",
        );
