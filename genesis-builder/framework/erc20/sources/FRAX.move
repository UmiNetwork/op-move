module ERC20::x853d955aCEf822Db058eb8505911ED77F175b99e {
    ...
    const ASSET_SYMBOL: vector<u8> = b"FRAX";
    const ASSET_NAME: vector<u8> = b"FRAX";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/FRAX/logo.svg"), /* icon */
            utf8(b"https://app.frax.finance/"), /* project */
        );
