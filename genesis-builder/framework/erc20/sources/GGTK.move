module ERC20::xfa99a87b14b02e2240c79240c5a20f945ca5ef76 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"GGTK";
    const ASSET_NAME: vector<u8> = b"GGToken";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/GGTK/logo.svg"), /* icon */
            utf8(b"https://ggdapp.com/"), /* project */
        );
