module ERC20::x3650B69f86cB593f116e276C30666834336c0647 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"LPF";
    const ASSET_NAME: vector<u8> = b"Loopfi";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/LPF/logo.svg"), /* icon */
            utf8(b"https://loopfi.io/"), /* project */
        );
