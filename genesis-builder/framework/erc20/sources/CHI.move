module ERC20::xfc2189D367d8d3D7CCA1aF43ff6169197DC7351e {
    ...
    const ASSET_SYMBOL: vector<u8> = b"CHI";
    const ASSET_NAME: vector<u8> = b"Chi USD";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/CHI/logo.svg"), /* icon */
            utf8(b"https://essencefinance.io"), /* project */
        );
