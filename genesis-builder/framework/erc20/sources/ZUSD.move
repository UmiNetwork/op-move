module ERC20::xc56c2b7e71B54d38Aab6d52E94a04Cbfa8F604fA {
    ...
    const ASSET_SYMBOL: vector<u8> = b"ZUSD";
    const ASSET_NAME: vector<u8> = b"Z.com USD";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            6, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/ZUSD/logo.svg"), /* icon */
            utf8(b"https://stablecoin.z.com/"), /* project */
        );
