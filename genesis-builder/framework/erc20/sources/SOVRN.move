module ERC20::x031B8d752d73d7Fe9678ACEf26e818280D0646b4 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SOVRN";
    const ASSET_NAME: vector<u8> = b"SOVRUN";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SOVRN/logo.svg"), /* icon */
            utf8(b"https://sovrun.org"), /* project */
        );
