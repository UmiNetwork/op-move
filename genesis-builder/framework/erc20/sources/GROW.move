module ERC20::x761a3557184cbc07b7493da0661c41177b2f97fa {
    ...
    const ASSET_SYMBOL: vector<u8> = b"GROW";
    const ASSET_NAME: vector<u8> = b"ValleyDAO Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/GROW/logo.svg"), /* icon */
            utf8(b"https://www.valleydao.bio"), /* project */
        );
