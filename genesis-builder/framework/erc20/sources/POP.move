module ERC20::xd0cd466b34a24fcb2f87676278af2005ca8a78c4 {
    ...
    const ASSET_NAME: vector<u8> = b"Popcorn";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/POP/logo.svg"), /* icon */
            utf8(b"https://www.popcorn.network"), /* project */
        );
