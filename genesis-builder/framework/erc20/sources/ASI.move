module ERC20::xaea46A60368A7bD060eec7DF8CBa43b7EF41Ad85 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"ASI";
    const ASSET_NAME: vector<u8> = b"ASI Alliance";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/ASI/logo.svg"), /* icon */
            utf8(b"https://www.superintelligence.io/"), /* project */
        );
