module ERC20::xB0B195aEFA3650A6908f15CdaC7D92F8a5791B0B {
    ...
    const ASSET_SYMBOL: vector<u8> = b"BOB";
    const ASSET_NAME: vector<u8> = b"BOB Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/BOB/logo.svg"), /* icon */
            utf8(b"https://www.zkbob.com/"), /* project */
        );
