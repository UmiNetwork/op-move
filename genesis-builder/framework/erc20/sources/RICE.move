module ERC20::xbd9908b0cdd50386f92efcc8e1d71766c2782df0 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"RICE";
    const ASSET_NAME: vector<u8> = b"DAOSquare Governance Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/RICE/logo.svg"), /* icon */
            utf8(b"https://www.daosquare.fi/"), /* project */
        );
