module ERC20::x4f604735c1cf31399c6e711d5962b2b3e0225ad3 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"USDGLO";
    const ASSET_NAME: vector<u8> = b"Glo Dollar";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/USDGLO/logo.svg"), /* icon */
            utf8(b"https://glodollar.org"), /* project */
        );
