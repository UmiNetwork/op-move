module ERC20::x616e8BfA43F920657B3497DBf40D6b1A02D4608d {
    ...
    const ASSET_SYMBOL: vector<u8> = b"auraBAL";
    const ASSET_NAME: vector<u8> = b"Aura BAL";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/auraBAL/logo.svg"), /* icon */
            utf8(b"https://app.aura.finance/"), /* project */
        );
