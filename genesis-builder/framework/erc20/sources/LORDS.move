module ERC20::x686f2404e77ab0d9070a46cdfb0b7fecdd2318b0 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"LORDS";
    const ASSET_NAME: vector<u8> = b"Lords";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/LORDS/logo.svg"), /* icon */
            utf8(b"https://realms.world/"), /* project */
        );
