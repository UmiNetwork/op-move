module ERC20::x6033F7f88332B8db6ad452B7C6D5bB643990aE3f {
    ...
    const ASSET_SYMBOL: vector<u8> = b"LSK";
    const ASSET_NAME: vector<u8> = b"Lisk";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/LSK/logo.svg"), /* icon */
            utf8(b"https://lisk.com"), /* project */
        );
