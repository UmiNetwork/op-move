module ERC20::x5fab9761d60419c9eeebe3915a8fa1ed7e8d2e1b {
    ...
    const ASSET_SYMBOL: vector<u8> = b"DIMO";
    const ASSET_NAME: vector<u8> = b"Dimo";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/DIMO/logo.svg"), /* icon */
            utf8(b"https://dimo.xyz"), /* project */
        );
