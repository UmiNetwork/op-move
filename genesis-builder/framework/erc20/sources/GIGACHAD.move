module ERC20::xF43F21384d03b5cBbddd58d2de64071e4Ce76AB0 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"GIGACHAD";
    const ASSET_NAME: vector<u8> = b"GigaChad";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/GIGACHAD/logo.svg"), /* icon */
            utf8(b"https://www.gigachad-eth.com/"), /* project */
        );
