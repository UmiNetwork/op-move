module ERC20::x88A9A52F944315D5B4e917b9689e65445C401E83 {
    use ERC20::base::Self;
    use aptos_framework::object::Object;
    use aptos_framework::fungible_asset_u256::Metadata;

    const ASSET_SYMBOL: vector<u8> = b"FEAR";
    const ASSET_NAME: vector<u8> = b"FEAR";
    ...
    fun init_module(admin: &signer) {
        let metadata = base::create_token_metadata(
            ...
            ASSET_NAME,
            18,
            b"https://ethereum-optimism.github.io/data/FEAR/logo.svg",
            b"https://www.fear.io/",
        );
