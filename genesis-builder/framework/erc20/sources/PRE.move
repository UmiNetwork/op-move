module ERC20::xEC213F83defB583af3A000B1c0ada660b1902A0F {
    ...
    const ASSET_SYMBOL: vector<u8> = b"PRE";
    const ASSET_NAME: vector<u8> = b"Presearch";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/PRE/logo.svg"), /* icon */
            utf8(b"https://presearch.io"), /* project */
        );
