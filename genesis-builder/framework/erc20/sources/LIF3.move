module ERC20::x7138Eb0d563f3F6722500936A11DcAe99D738A2c {
    ...
    const ASSET_SYMBOL: vector<u8> = b"LIF3";
    const ASSET_NAME: vector<u8> = b"LIF3";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/LIF3/logo.svg"), /* icon */
            utf8(b"https://lif3.com/"), /* project */
        );
