module ERC20::xc2544A32872A91F4A553b404C6950e89De901fdb {
    ...
    const ASSET_SYMBOL: vector<u8> = b"FPIS";
    const ASSET_NAME: vector<u8> = b"Frax Price Index Share";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/FPIS/logo.svg"), /* icon */
