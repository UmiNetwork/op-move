module ERC20::x9a96ec9B57Fb64FbC60B423d1f4da7691Bd35079 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"AJNA";
    const ASSET_NAME: vector<u8> = b"Ajna";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/AJNA/logo.svg"), /* icon */
