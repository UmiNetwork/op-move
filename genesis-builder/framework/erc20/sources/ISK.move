module ERC20::x17d2628D30F8e9E966c9Ba831c9B9b01ea8Ea75C {
    ...
    const ASSET_SYMBOL: vector<u8> = b"ISK";
    const ASSET_NAME: vector<u8> = b"ISKRA TOKEN";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/ISK/logo.svg"), /* icon */
            utf8(b"https://iskra.world"), /* project */
        );
