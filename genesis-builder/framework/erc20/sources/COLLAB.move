module ERC20::x8B21e9b7dAF2c4325bf3D18c1BeB79A347fE902A {
    ...
    const ASSET_SYMBOL: vector<u8> = b"COLLAB";
    const ASSET_NAME: vector<u8> = b"Collab.Land";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/COLLAB/logo.svg"), /* icon */
            utf8(b"https://collab.land"), /* project */
        );
