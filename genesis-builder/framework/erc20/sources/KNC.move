module ERC20::xdeFA4e8a7bcBA345F687a2f1456F5Edd9CE97202 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"KNC";
    const ASSET_NAME: vector<u8> = b"Kyber Network Crystal v2";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/KNC/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
