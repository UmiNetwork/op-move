module ERC20::x18084fbA666a33d37592fA2633fD49a74DD93a88 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"tBTC";
    const ASSET_NAME: vector<u8> = b"tBTC v2";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/tBTC/logo.svg"), /* icon */
