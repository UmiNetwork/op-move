module ERC20::x7f39C581F595B53c5cb19bD0b3f8dA6c935E2Ca0 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"wstETH";
    const ASSET_NAME: vector<u8> = b"Wrapped liquid staked Ether 2.0";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/wstETH/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
