module ERC20::x01ba67aac7f75f647d94220cc98fb30fcc5105bf {
    ...
    const ASSET_SYMBOL: vector<u8> = b"LYRA";
    const ASSET_NAME: vector<u8> = b"Lyra";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/LYRA/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
