module ERC20::x5f98805a4e8be255a32880fdec7f6728c6568ba0 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"LUSD";
    const ASSET_NAME: vector<u8> = b"LUSD Stablecoin";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/LUSD/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
