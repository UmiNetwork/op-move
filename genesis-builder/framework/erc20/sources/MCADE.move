module ERC20::xed328e9c1179a30ddc1e7595e036aed8760c22af {
    ...
    const ASSET_SYMBOL: vector<u8> = b"MCADE";
    const ASSET_NAME: vector<u8> = b"Metacade";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/MCADE/logo.svg"), /* icon */
            utf8(b"https://metacade.co/"), /* project */
        );
