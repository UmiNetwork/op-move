module ERC20::x865377367054516e17014CcdED1e7d814EDC9ce4 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"DOLA";
    const ASSET_NAME: vector<u8> = b"Dola USD Stablecoin";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/DOLA/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
