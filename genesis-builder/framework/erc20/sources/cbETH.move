module ERC20::xbe9895146f7af43049ca1c1ae358b0541ea49704 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"cbETH";
    const ASSET_NAME: vector<u8> = b"Coinbase Wrapped Staked ETH";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/cbETH/logo.svg"), /* icon */
            utf8(b"https://www.coinbase.com/"), /* project */
        );
