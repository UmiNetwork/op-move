module ERC20::xdd3B11eF34cd511a2DA159034a05fcb94D806686 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"REKT";
    const ASSET_NAME: vector<u8> = b"Rekt";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/REKT/logo.svg"), /* icon */
            utf8(b"https://rektcoin.com"), /* project */
        );
