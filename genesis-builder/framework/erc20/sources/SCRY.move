module ERC20::x0000000000071821e8033345a7be174647be0706 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SCRY";
    const ASSET_NAME: vector<u8> = b"Scry Protocol";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SCRY/logo.svg"), /* icon */
            utf8(b"https://www.docs.scry.finance/"), /* project */
        );
