module ERC20::x259ab9b9eab62b0fd98729b97be121073d5b3479 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"EST";
    const ASSET_NAME: vector<u8> = b"Erica Social Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/EST/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
