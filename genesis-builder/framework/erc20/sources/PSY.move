module ERC20::x2196B84EaCe74867b73fb003AfF93C11FcE1D47A {
    ...
    const ASSET_SYMBOL: vector<u8> = b"PSY";
    const ASSET_NAME: vector<u8> = b"PsyDAO Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/PSY/logo.svg"), /* icon */
            utf8(b"https://www.psydao.io/"), /* project */
        );
