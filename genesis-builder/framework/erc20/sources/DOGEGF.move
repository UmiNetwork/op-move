module ERC20::xfb130d93E49DcA13264344966A611dc79a456Bc5 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"DOGEGF";
    const ASSET_NAME: vector<u8> = b"DogeGF";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/DOGEGF/logo.svg"), /* icon */
            utf8(b"https://www.dogegf.com/"), /* project */
        );
