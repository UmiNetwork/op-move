module ERC20::xD31a59c85aE9D8edEFeC411D448f90841571b89c {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SOL";
    const ASSET_NAME: vector<u8> = b"Wrapped SOL";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            9, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SOL/logo.svg"), /* icon */
            utf8(b"https://wormhole.com"), /* project */
        );
