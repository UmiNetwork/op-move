module ERC20::x3446dd70b2d52a6bf4a5a192d9b0a161295ab7f9 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SUDO";
    const ASSET_NAME: vector<u8> = b"SUDO GOVERNANCE TOKEN";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SUDO/logo.svg"), /* icon */
            utf8(b"https://sudoswap.xyz/"), /* project */
        );
