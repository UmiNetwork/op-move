module ERC20::x7cb683151a83c2b10a30cbb003cda9996228a2ba {
    ...
    const ASSET_SYMBOL: vector<u8> = b"IYKYK";
    const ASSET_NAME: vector<u8> = b"IYKYK";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/IYKYK/logo.svg"), /* icon */
            utf8(b"https://fins.wtf"), /* project */
        );
