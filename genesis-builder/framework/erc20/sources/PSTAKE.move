module ERC20::xfB5c6815cA3AC72Ce9F5006869AE67f18bF77006 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"PSTAKE";
    const ASSET_NAME: vector<u8> = b"pSTAKE Finance";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/PSTAKE/logo.svg"), /* icon */
            utf8(b"https://pstake.finance"), /* project */
        );
