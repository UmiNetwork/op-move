module ERC20::x1571eD0bed4D987fe2b498DdBaE7DFA19519F651 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"iFARM";
    const ASSET_NAME: vector<u8> = b"iFARM";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/IFARM/logo.svg"), /* icon */
