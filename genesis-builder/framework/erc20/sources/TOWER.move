module ERC20::x1C9922314ED1415c95b9FD453c3818fd41867d0B {
    ...
    const ASSET_SYMBOL: vector<u8> = b"TOWER";
    const ASSET_NAME: vector<u8> = b"TOWER";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/TOWER/logo.svg"), /* icon */
            utf8(b"https://www.crazydefenseheroes.com/"), /* project */
        );
