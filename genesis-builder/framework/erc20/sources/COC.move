module ERC20::xc8d9871a79551ab4439c9e08f12962e3785f0437 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"COC";
    const ASSET_NAME: vector<u8> = b"CryptoOracle Collective";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/COC/logo.svg"), /* icon */
            utf8(b"https://www.cryptooracle.io/"), /* project */
        );
