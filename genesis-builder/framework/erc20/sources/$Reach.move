module ERC20::x8b12bd54ca9b2311960057c8f3c88013e79316e3 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"$Reach";
    const ASSET_NAME: vector<u8> = b"Reach";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/REACH/logo.svg"), /* icon */
            utf8(b"https://getreach.xyz"), /* project */
        );
