module ERC20::x6399c842dd2be3de30bf99bc7d1bbf6fa3650e70 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"PREMIA";
    const ASSET_NAME: vector<u8> = b"Premia";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/PREMIA/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
