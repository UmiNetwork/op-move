module ERC20::x06F3C323f0238c72BF35011071f2b5B7F43A054c {
    ...
    const ASSET_SYMBOL: vector<u8> = b"MASQ";
    const ASSET_NAME: vector<u8> = b"MASQ";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/MASQ/logo.svg"), /* icon */
            utf8(b"https://www.masqbrowser.com/"), /* project */
        );
