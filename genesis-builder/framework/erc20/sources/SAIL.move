module ERC20::xd8F1460044925d2D5c723C7054cd9247027415B7 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SAIL";
    const ASSET_NAME: vector<u8> = b"SAIL Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SAIL/logo.svg"), /* icon */
            utf8(b"https://www.admiraldao.xyz/sail"), /* project */
        );
