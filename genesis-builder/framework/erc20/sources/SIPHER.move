module ERC20::x9F52c8ecbEe10e00D9faaAc5Ee9Ba0fF6550F511 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SIPHER";
    const ASSET_NAME: vector<u8> = b"Sipher Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SIPHER/logo.svg"), /* icon */
            utf8(b"https://playsipher.com/"), /* project */
        );
