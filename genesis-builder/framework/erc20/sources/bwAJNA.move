module ERC20::x936Ab482d6bd111910a42849D3A51Ff80BB0A711 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"bwAJNA";
    const ASSET_NAME: vector<u8> = b"Burn Wrapped AJNA";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/bwAJNA/logo.svg"), /* icon */
            utf8(b"https://www.ajna.finance/team"), /* project */
        );
