module ERC20::xbC396689893D065F41bc2C6EcbeE5e0085233447 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"PERP";
    const ASSET_NAME: vector<u8> = b"Perpetual";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/PERP/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
