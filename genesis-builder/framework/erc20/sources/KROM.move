module ERC20::x3af33bef05c2dcb3c7288b77fe1c8d2aeba4d789 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"KROM";
    const ASSET_NAME: vector<u8> = b"Kromatika";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/KROM/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
