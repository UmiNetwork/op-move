module ERC20::x0943a203d80d89D79Bf5EAa1780Fc72A016FB729 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"AKIRA";
    const ASSET_NAME: vector<u8> = b"Akira Dog";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/AKIRA/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
