module ERC20::xa3BeD4E1c75D00fa6f4E5E6922DB7261B5E9AcD2 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"MTA";
    const ASSET_NAME: vector<u8> = b"Meta";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/MTA/logo.svg"), /* icon */
            utf8(b"https://mstable.org/"), /* project */
        );
