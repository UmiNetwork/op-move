module ERC20::x525574C899A7c877a11865339e57376092168258 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"GURU";
    const ASSET_NAME: vector<u8> = b"GURU Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/GURU/logo.svg"), /* icon */
            utf8(b"https://gurunetwork.ai"), /* project */
        );
