module ERC20::x86ed939B500E121C0C5f493F399084Db596dAd20 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SPC";
    const ASSET_NAME: vector<u8> = b"SpaceChainV2";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SPC/logo.svg"), /* icon */
            utf8(b"https://www.spacechain.com/"), /* project */
        );
