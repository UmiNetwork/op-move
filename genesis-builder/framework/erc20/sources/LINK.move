module ERC20::x514910771af9ca656af840dff83e8264ecf986ca {
    ...
    const ASSET_SYMBOL: vector<u8> = b"LINK";
    const ASSET_NAME: vector<u8> = b"Chainlink";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/LINK/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
