module ERC20::xD533a949740bb3306d119CC777fa900bA034cd52 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"CRV";
    const ASSET_NAME: vector<u8> = b"Curve DAO Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/CRV/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
