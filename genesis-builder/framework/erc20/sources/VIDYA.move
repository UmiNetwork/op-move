module ERC20::x3d3d35bb9bec23b06ca00fe472b50e7a4c692c30 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"VIDYA";
    const ASSET_NAME: vector<u8> = b"Vidya";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/VIDYA/logo.svg"), /* icon */
            utf8(b"https://team3d.io"), /* project */
        );
