module ERC20::xDd66781D0E9a08D4FBb5eC7BAc80B691BE27F21D {
    ...
    const ASSET_SYMBOL: vector<u8> = b"AXGT";
    const ASSET_NAME: vector<u8> = b"AxonDAO Governance Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/AXGT/logo.svg"), /* icon */
            utf8(b"https://axondao.io/"), /* project */
        );
