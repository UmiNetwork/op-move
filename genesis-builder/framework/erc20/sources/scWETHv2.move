module ERC20::x4c406C068106375724275Cbff028770C544a1333 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"scWETHv2";
    const ASSET_NAME: vector<u8> = b"Sandclock WETH Vault v2";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/scWETHv2/logo.svg"), /* icon */
            utf8(b"https://sandclock.org"), /* project */
        );
