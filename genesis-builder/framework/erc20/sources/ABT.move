module ERC20::xB98d4C97425d9908E66E53A6fDf673ACcA0BE986 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"ABT";
    const ASSET_NAME: vector<u8> = b"ArcBlock";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/ABT/logo.svg"), /* icon */
            utf8(b"https://www.arcblock.io"), /* project */
        );
