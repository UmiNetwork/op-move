module ERC20::x320623b8e4ff03373931769a31fc52a4e78b5d70 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"RSR";
    const ASSET_NAME: vector<u8> = b"Reserve Rights";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/RSR/logo.svg"), /* icon */
            utf8(b"https://register.app/"), /* project */
        );
