module ERC20::x88800092fF476844f74dC2FC427974BBee2794Ae {
    ...
    const ASSET_SYMBOL: vector<u8> = b"WALLET";
    const ASSET_NAME: vector<u8> = b"Ambire Wallet";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/WALLET/logo.svg"), /* icon */
            utf8(b"https://ambire.com"), /* project */
        );
