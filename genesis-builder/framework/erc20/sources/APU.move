module ERC20::x594daad7d77592a2b97b725a7ad59d7e188b5bfa {
    ...
    const ASSET_SYMBOL: vector<u8> = b"APU";
    const ASSET_NAME: vector<u8> = b"Apu Apustaja";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/APU/logo.svg"), /* icon */
            utf8(b"https://apu.community/"), /* project */
        );
