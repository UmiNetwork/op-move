module ERC20::x04Fa0d235C4abf4BcF4787aF4CF447DE572eF828 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"UMA";
    const ASSET_NAME: vector<u8> = b"UMA Voting Token v1";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/UMA/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
