module ERC20::x085780639CC2cACd35E474e71f4d000e2405d8f6 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"fxUSD";
    const ASSET_NAME: vector<u8> = b"f(x) USD";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/fxUSD/logo.svg"), /* icon */
            utf8(b"https://fx.aladdin.club/"), /* project */
        );
