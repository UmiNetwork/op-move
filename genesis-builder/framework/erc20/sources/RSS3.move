module ERC20::xc98D64DA73a6616c42117b582e832812e7B8D57F {
    ...
    const ASSET_SYMBOL: vector<u8> = b"RSS3";
    const ASSET_NAME: vector<u8> = b"RSS3";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/RSS3/logo.svg"), /* icon */
            utf8(b"https://rss3.io/"), /* project */
        );
