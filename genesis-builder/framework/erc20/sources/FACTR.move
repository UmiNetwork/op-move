module ERC20::xe0bCEEF36F3a6eFDd5EEBFACD591423f8549B9D5 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"FACTR";
    const ASSET_NAME: vector<u8> = b"Defactor";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/FACTR/logo.svg"), /* icon */
            utf8(b"https://www.defactor.com/"), /* project */
        );
