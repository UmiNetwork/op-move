module ERC20::xc52fafdc900cb92ae01e6e4f8979af7f436e2eb2 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SEXY";
    const ASSET_NAME: vector<u8> = b"Settled ETHXY Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SEXY/logo.svg"), /* icon */
            utf8(b"https://ethxy.com/"), /* project */
        );
