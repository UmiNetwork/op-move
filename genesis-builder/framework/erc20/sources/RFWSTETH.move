module ERC20::x07FA101efde726E0956Edd2c4D5C8d3d1A5E9c53 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"RFWSTETH";
    const ASSET_NAME: vector<u8> = b"Respawn Finance Wrapped Staked Ethereum";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/RFWSTETH/logo.svg"), /* icon */
            utf8(b"https://respawn.finance/"), /* project */
        );
