module ERC20::x42bBFa2e77757C645eeaAd1655E0911a7553Efbc {
    ...
    const ASSET_SYMBOL: vector<u8> = b"BOBA";
    const ASSET_NAME: vector<u8> = b"Boba Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/BOBA/logo.svg"), /* icon */
            utf8(b"https://boba.network"), /* project */
        );
