module ERC20::x8353b92201f19b4812eee32efd325f7ede123718 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SCM";
    const ASSET_NAME: vector<u8> = b"Scamfari";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SCM/logo.svg"), /* icon */
            utf8(b"https://scamfari.com/"), /* project */
        );
