module ERC20::x0590cc9232eBF68D81F6707A119898219342ecB9 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"BCAT";
    const ASSET_NAME: vector<u8> = b"BananaCat";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            9, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/BCAT/logo.svg"), /* icon */
            utf8(b"https://bananacat.community/"), /* project */
        );
