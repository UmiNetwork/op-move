module ERC20::x7ABc8A5768E6bE61A6c693a6e4EAcb5B60602C4D {
    ...
    const ASSET_SYMBOL: vector<u8> = b"CXT";
    const ASSET_NAME: vector<u8> = b"Covalent X Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/CXT/logo.svg"), /* icon */
            utf8(b"https://covalenthq.com"), /* project */
        );
