module ERC20::x0391D2021f89DC339F60Fff84546EA23E337750f {
    ...
    const ASSET_SYMBOL: vector<u8> = b"BOND";
    const ASSET_NAME: vector<u8> = b"BarnBridge Governance Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/BOND/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
