module ERC20::xc8168d5665f4418353728ac970713e09C0B7c20e {
    ...
    const ASSET_SYMBOL: vector<u8> = b"MONKE";
    const ASSET_NAME: vector<u8> = b"MONKE";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/MONKE/logo.svg"), /* icon */
            utf8(b"https://monke-erc.com"), /* project */
        );
