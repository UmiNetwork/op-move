module ERC20::x967da4048cD07aB37855c090aAF366e4ce1b9F48 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"OCEAN";
    const ASSET_NAME: vector<u8> = b"Ocean Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/OCEAN/logo.svg"), /* icon */
            utf8(b"https://www.oceanprotocol.com"), /* project */
        );
