module ERC20::x77FbA179C79De5B7653F68b5039Af940AdA60ce0 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"FORTH";
    const ASSET_NAME: vector<u8> = b"Ampleforth Governance";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/FORTH/logo.svg"), /* icon */
            utf8(b"https://ampleforth.org"), /* project */
        );
