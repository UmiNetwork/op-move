module ERC20::xc00e94Cb662C3520282E6f5717214004A7f26888 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"COMP";
    const ASSET_NAME: vector<u8> = b"Compound";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/COMP/logo.svg"), /* icon */
            utf8(b"https://compound.finance/"), /* project */
        );
