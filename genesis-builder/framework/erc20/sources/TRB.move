module ERC20::x88df592f8eb5d7bd38bfef7deb0fbc02cf3778a0 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"TRB";
    const ASSET_NAME: vector<u8> = b"Tellor";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/TRB/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
