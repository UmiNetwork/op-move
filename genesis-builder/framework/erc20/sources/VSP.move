module ERC20::x1b40183EFB4Dd766f11bDa7A7c3AD8982e998421 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"VSP";
    const ASSET_NAME: vector<u8> = b"VesperToken";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/VSP/logo.svg"), /* icon */
            utf8(b"https://vesper.finance/"), /* project */
        );
