module ERC20::xC4C2614E694cF534D407Ee49F8E44D125E4681c4 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"CHAIN";
    const ASSET_NAME: vector<u8> = b"Chain Games";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/CHAIN/logo.svg"), /* icon */
            utf8(b"https://chaingames.io/"), /* project */
        );
