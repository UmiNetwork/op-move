module ERC20::xc82e3db60a52cf7529253b4ec688f631aad9e7c2 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"ARC";
    const ASSET_NAME: vector<u8> = b"ARC";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/ARC/logo.svg"), /* icon */
            utf8(b"https://www.arc.ai"), /* project */
        );
