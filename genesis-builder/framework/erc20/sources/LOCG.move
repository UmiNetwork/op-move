module ERC20::x60Eb57d085C59932d5fAa6c6026268A4386927d0 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"LOCG";
    const ASSET_NAME: vector<u8> = b"LOCGame";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/LOCG/logo.svg"), /* icon */
            utf8(b"https://locgame.io"), /* project */
        );
