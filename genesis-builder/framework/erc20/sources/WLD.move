module ERC20::x163f8C2467924be0ae7B5347228CABF260318753 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"WLD";
    const ASSET_NAME: vector<u8> = b"Worldcoin";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/WLD/logo.svg"), /* icon */
            utf8(b"https://worldcoin.org"), /* project */
        );
