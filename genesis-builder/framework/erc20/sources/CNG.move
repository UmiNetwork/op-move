module ERC20::x5C1d9aA868a30795F92fAe903eDc9eFF269044bf {
    ...
    const ASSET_SYMBOL: vector<u8> = b"CNG";
    const ASSET_NAME: vector<u8> = b"Changer";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/CNG/logo.svg"), /* icon */
            utf8(b"https://changer.io/"), /* project */
        );
