module ERC20::x1BED97CBC3c24A4fb5C069C6E311a967386131f7 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"yETH";
    const ASSET_NAME: vector<u8> = b"Yearn Ether";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/yETH/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
