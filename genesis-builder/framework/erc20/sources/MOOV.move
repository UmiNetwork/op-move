module ERC20::x4116f14b6d462B32a1C10F98049E4B1765e34FA9 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"MOOV";
    const ASSET_NAME: vector<u8> = b"dotmoovs";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/MOOV/logo.svg"), /* icon */
            utf8(b"https://dotmoovs.com"), /* project */
        );
