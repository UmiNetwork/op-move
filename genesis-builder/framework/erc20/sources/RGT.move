module ERC20::xd291e7a03283640fdc51b121ac401383a46cc623 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"RGT";
    const ASSET_NAME: vector<u8> = b"Rari Governance Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/RGT/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
