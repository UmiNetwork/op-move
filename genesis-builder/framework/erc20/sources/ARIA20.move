module ERC20::xeDF6568618A00C6F0908Bf7758A16F76B6E04aF9 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"ARIA20";
    const ASSET_NAME: vector<u8> = b"ARIANEE";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/ARIA20/logo.svg"), /* icon */
            utf8(b"https://www.arianee.org"), /* project */
        );
