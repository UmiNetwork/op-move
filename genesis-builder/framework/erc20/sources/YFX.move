module ERC20::xF55a93b613D172b86c2Ba3981a849DaE2aeCDE2f {
    ...
    const ASSET_SYMBOL: vector<u8> = b"YFX";
    const ASSET_NAME: vector<u8> = b"YFX Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/YFX/logo.svg"), /* icon */
            utf8(b"https://yfx.com/"), /* project */
        );
