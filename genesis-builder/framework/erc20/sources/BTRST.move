module ERC20::x799ebfABE77a6E34311eeEe9825190B9ECe32824 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"BTRST";
    const ASSET_NAME: vector<u8> = b"BTRST";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/BTRST/logo.svg"), /* icon */
            utf8(b"https://www.usebraintrust.com/"), /* project */
        );
