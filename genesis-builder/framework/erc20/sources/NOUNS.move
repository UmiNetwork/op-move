module ERC20::x5c1760c98be951A4067DF234695c8014D8e7619C {
    ...
    const ASSET_SYMBOL: vector<u8> = b"NOUNS";
    const ASSET_NAME: vector<u8> = b"Nouns";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/NOUNS/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
