module ERC20::x9559Aaa82d9649C7A7b220E7c461d2E74c9a3593 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"rETH";
    const ASSET_NAME: vector<u8> = b"StaFi Staked ETH";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/rETH_StaFi/logo.svg"), /* icon */
            utf8(b"https://stafi.io"), /* project */
        );
