module ERC20::x38547D918b9645F2D94336B6b61AEB08053E142c {
    ...
    const ASSET_SYMBOL: vector<u8> = b"USC";
    const ASSET_NAME: vector<u8> = b"USC";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/USC/logo.svg"), /* icon */
            utf8(b"https://chiprotocol.io/"), /* project */
        );
