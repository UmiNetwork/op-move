module ERC20::x7c5b267ed81009aa7374b5ca7e5137da47045ba8 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"TKAI";
    const ASSET_NAME: vector<u8> = b"TAIKAI Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/TKAI/logo.svg"), /* icon */
            utf8(b"https://taikai.network"), /* project */
        );
