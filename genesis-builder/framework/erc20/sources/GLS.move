module ERC20::x68E2e5c9DFF32419A108713f83274a4Fb5e194CA {
    ...
    const ASSET_SYMBOL: vector<u8> = b"GLS";
    const ASSET_NAME: vector<u8> = b"Glacier Network";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/GLS/logo.svg"), /* icon */
            utf8(b"https://www.glacier.io/"), /* project */
        );
