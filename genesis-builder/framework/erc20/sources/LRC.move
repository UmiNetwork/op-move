module ERC20::xBBbbCA6A901c926F240b89EacB641d8Aec7AEafD {
    ...
    const ASSET_SYMBOL: vector<u8> = b"LRC";
    const ASSET_NAME: vector<u8> = b"LoopringCoin V2";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/LRC/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
