module ERC20::xF655C8567E0f213e6C634CD2A68d992152161dC6 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"IBEX";
    const ASSET_NAME: vector<u8> = b"Impermax";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/IBEX/logo.svg"), /* icon */
            utf8(b"https://impermax.finance"), /* project */
        );
