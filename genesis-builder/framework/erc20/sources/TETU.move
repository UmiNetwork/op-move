module ERC20::x0F72964Fa4b766521d84107991E837c30D0EF2b1 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"TETU";
    const ASSET_NAME: vector<u8> = b"Tetu Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/TETU/logo.svg"), /* icon */
            utf8(b"https://tetu.io"), /* project */
        );
