module ERC20::x9f8f72aa9304c8b593d555f12ef6589cc3a579a2 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"MKR";
    const ASSET_NAME: vector<u8> = b"Maker";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/MKR/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
