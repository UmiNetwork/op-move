module ERC20::x617ead3c59ded3ea1bb17881118cf310144b450f {
    ...
    const ASSET_SYMBOL: vector<u8> = b"TSC";
    const ASSET_NAME: vector<u8> = b"The Secret Coin";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/TSC/logo.svg"), /* icon */
            utf8(b"http://www.thesecretcoin.io/"), /* project */
        );
