module ERC20::x1f9840a85d5af5bf1d1762f925bdaddc4201f984 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"UNI";
    const ASSET_NAME: vector<u8> = b"Uniswap";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/UNI/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
