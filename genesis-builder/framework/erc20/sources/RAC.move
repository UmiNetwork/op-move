module ERC20::xc22B30E4cce6b78aaaADae91E44E73593929a3e9 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"RAC";
    const ASSET_NAME: vector<u8> = b"RAC";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/RAC/logo.svg"), /* icon */
            utf8(b"https://rac.fm"), /* project */
        );
