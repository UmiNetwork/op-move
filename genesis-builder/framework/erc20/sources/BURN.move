module ERC20::xa2fe5e51729be71261bcf42854012827bc44c044 {
    ...
    const ASSET_NAME: vector<u8> = b"Burn";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/BURN/logo.svg"), /* icon */
            utf8(b"https://www.deflationary.com/"), /* project */
        );
