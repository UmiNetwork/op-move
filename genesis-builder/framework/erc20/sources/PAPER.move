module ERC20::x7ae1d57b58fa6411f32948314badd83583ee0e8c {
    ...
    const ASSET_SYMBOL: vector<u8> = b"PAPER";
    const ASSET_NAME: vector<u8> = b"Paper";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/PAPER/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
