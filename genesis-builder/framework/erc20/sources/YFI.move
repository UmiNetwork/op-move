module ERC20::x0bc529c00C6401aEF6D220BE8C6Ea1667F6Ad93e {
    ...
    const ASSET_SYMBOL: vector<u8> = b"YFI";
    const ASSET_NAME: vector<u8> = b"yearn.finance";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/YFI/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
