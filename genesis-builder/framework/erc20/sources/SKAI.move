module ERC20::xCF078DA6e85389de507ceeDE0E3d217e457B9d49 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SKAI";
    const ASSET_NAME: vector<u8> = b"Skillful AI";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SKAI/logo.svg"), /* icon */
            utf8(b"https://www.skillfulai.io/"), /* project */
        );
