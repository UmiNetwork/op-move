module ERC20::xdfdb7f72c1f195c5951a234e8db9806eb0635346 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"NFD";
    const ASSET_NAME: vector<u8> = b"Feisty Doge";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/NFD/logo.svg"), /* icon */
            utf8(b"https://feistydoge.art/"), /* project */
        );
