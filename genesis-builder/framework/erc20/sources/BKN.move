module ERC20::x0A638F07ACc6969abF392bB009f216D22aDEa36d {
    ...
    const ASSET_SYMBOL: vector<u8> = b"BKN";
    const ASSET_NAME: vector<u8> = b"Brickken";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/BKN/logo.svg"), /* icon */
            utf8(b"https://brickken.com"), /* project */
        );
