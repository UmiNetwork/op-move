module ERC20::x8dce83eca4af45dbe618da1779f9aaca43201084 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"AIKEK";
    const ASSET_NAME: vector<u8> = b"AlphaKEK.AI";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/AIKEK/logo.svg"), /* icon */
            utf8(b"https://alphakek.ai"), /* project */
        );
