module ERC20::x4946Fcea7C692606e8908002e55A582af44AC121 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"FOAM";
    const ASSET_NAME: vector<u8> = b"FOAM Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/FOAM/logo.svg"), /* icon */
            utf8(b"https://foam.space"), /* project */
        );
