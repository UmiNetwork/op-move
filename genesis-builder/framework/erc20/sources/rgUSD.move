module ERC20::x78da5799CF427Fee11e9996982F4150eCe7a99A7 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"rgUSD";
    const ASSET_NAME: vector<u8> = b"Revenue Generating USD";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/rgUSD/logo.svg"), /* icon */
            utf8(b"https://app.reserve.org/ethereum/token/0x78da5799cf427fee11e9996982f4150ece7a99a7/overview"), /* project */
        );
