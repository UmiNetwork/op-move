module ERC20::xc944e90c64b2c07662a292be6244bdf05cda44a7 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"GRT";
    const ASSET_NAME: vector<u8> = b"Graph Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/GRT/logo.svg"), /* icon */
            utf8(b"https://thegraph.com/"), /* project */
        );
