module ERC20::xEDB171C18cE90B633DB442f2A6F72874093b49Ef {
    ...
    const ASSET_SYMBOL: vector<u8> = b"WAMPL";
    const ASSET_NAME: vector<u8> = b"Wrapped Ampleforth";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/WAMPL/logo.svg"), /* icon */
