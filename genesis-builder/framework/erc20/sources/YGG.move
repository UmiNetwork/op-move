module ERC20::x25f8087EAD173b73D6e8B84329989A8eEA16CF73 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"YGG";
    const ASSET_NAME: vector<u8> = b"Yield Guild Games Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/YGG/logo.svg"), /* icon */
            utf8(b"https://www.yieldguild.io/"), /* project */
        );
