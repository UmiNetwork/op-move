module ERC20::x039b598c6b99e70058E1e9021E000BdacD33d026 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"MORPHO";
    const ASSET_NAME: vector<u8> = b"Morpho Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/MORPHO_DEPRECATED/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
