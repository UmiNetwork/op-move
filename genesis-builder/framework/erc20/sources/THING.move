module ERC20::x2c9084e65d046146d6cfc26bf45f5b80042b90eb {
    ...
    const ASSET_SYMBOL: vector<u8> = b"THING";
    const ASSET_NAME: vector<u8> = b"Current Thing";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/THING/logo.svg"), /* icon */
            utf8(b"https://www.npc-land.com/"), /* project */
        );
