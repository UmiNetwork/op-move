module ERC20::x5e8422345238f34275888049021821e8e08caa1f {
    ...
    const ASSET_SYMBOL: vector<u8> = b"frxETH";
    const ASSET_NAME: vector<u8> = b"Frax Ether";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/frxETH/logo.svg"), /* icon */
