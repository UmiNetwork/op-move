module ERC20::x09395a2A58DB45db0da254c7EAa5AC469D8bDc85 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SQT";
    const ASSET_NAME: vector<u8> = b"SubQueryToken";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SQT/logo.svg"), /* icon */
            utf8(b"https://subquery.network"), /* project */
        );
