module ERC20::xc2e660C62F72c2ad35AcE6DB78a616215E2F2222 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"zunETH";
    const ASSET_NAME: vector<u8> = b"Zunami ETH";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/zunETH/logo.svg"), /* icon */
