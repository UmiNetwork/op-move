module ERC20::x4Bbf46E7c31eDc1F33aF4d57F0C4a0f13398427c {
    ...
    const ASSET_SYMBOL: vector<u8> = b"MBS";
    const ASSET_NAME: vector<u8> = b"MBS";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/MBS/logo.svg"), /* icon */
            utf8(b"https://monkeyleague.io"), /* project */
        );
