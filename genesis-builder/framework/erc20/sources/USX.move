module ERC20::x0a5e677a6a24b2f1a2bf4f3bffc443231d2fdec8 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"USX";
    const ASSET_NAME: vector<u8> = b"dForce USD";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/USX/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
