module ERC20::x6b5204b0be36771253cc38e88012e02b752f0f36 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"ZUN";
    const ASSET_NAME: vector<u8> = b"Zunami Governance Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/ZUN/logo.svg"), /* icon */
            utf8(b"https://www.zunami.io/"), /* project */
        );
