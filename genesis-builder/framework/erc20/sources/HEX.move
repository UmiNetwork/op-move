module ERC20::x2b591e99afE9f32eAA6214f7B7629768c40Eeb39 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"HEX";
    const ASSET_NAME: vector<u8> = b"HEX";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            8, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/HEX/logo.svg"), /* icon */
            utf8(b"https://hex.com/"), /* project */
        );
