module ERC20::x44108f0223A3C3028F5Fe7AEC7f9bb2E66beF82F {
    ...
    const ASSET_SYMBOL: vector<u8> = b"ACX";
    const ASSET_NAME: vector<u8> = b"Across Protocol Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/ACX/logo.svg"), /* icon */
            utf8(b"https://docs.across.to/v2/"), /* project */
        );
