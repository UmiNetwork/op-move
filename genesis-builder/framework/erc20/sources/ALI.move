module ERC20::x6B0b3a982b4634aC68dD83a4DBF02311cE324181 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"ALI";
    const ASSET_NAME: vector<u8> = b"Artificial Liquid Intelligence Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/ALI/logo.svg"), /* icon */
            utf8(b"https://alethea.ai/"), /* project */
        );
