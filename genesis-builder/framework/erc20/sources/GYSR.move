module ERC20::xbEa98c05eEAe2f3bC8c3565Db7551Eb738c8CCAb {
    ...
    const ASSET_SYMBOL: vector<u8> = b"GYSR";
    const ASSET_NAME: vector<u8> = b"Geyser";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/GYSR/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
