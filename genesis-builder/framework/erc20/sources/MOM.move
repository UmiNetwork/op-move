module ERC20::x1351986732367ff6B51784c6A75f63502dE13a9a {
    ...
    const ASSET_SYMBOL: vector<u8> = b"MOM";
    const ASSET_NAME: vector<u8> = b"Monetum";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/MOM/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
