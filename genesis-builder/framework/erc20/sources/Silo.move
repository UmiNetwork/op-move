module ERC20::x6f80310CA7F2C654691D1383149Fa1A57d8AB1f8 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"Silo";
    const ASSET_NAME: vector<u8> = b"Silo Governance Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/Silo/logo.svg"), /* icon */
            utf8(b"https://silo.finance/"), /* project */
        );
