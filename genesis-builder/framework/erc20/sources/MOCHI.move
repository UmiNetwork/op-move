module ERC20::xf134519cBE2042B06Ee7cE20Df51d09b55559896 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"MOCHI";
    const ASSET_NAME: vector<u8> = b"Mochi";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/MOCHI/logo.svg"), /* icon */
            utf8(b"https://mochi.game"), /* project */
        );
