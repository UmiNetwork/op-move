module ERC20::xd0a6053f087e87a25dc60701ba6e663b1a548e85 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"LRDS";
    const ASSET_NAME: vector<u8> = b"BLOCKLORDS";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/LRDS/logo.svg"), /* icon */
            utf8(b"https://www.blocklords.com/"), /* project */
        );
