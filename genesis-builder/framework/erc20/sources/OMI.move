module ERC20::xeD35af169aF46a02eE13b9d79Eb57d6D68C1749e {
    ...
    const ASSET_SYMBOL: vector<u8> = b"OMI";
    const ASSET_NAME: vector<u8> = b"OMI Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/OMI/logo.svg"), /* icon */
            utf8(b"https://www.ecomi.com/"), /* project */
        );
