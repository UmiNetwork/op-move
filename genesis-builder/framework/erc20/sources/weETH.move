module ERC20::xCd5fE23C85820F7B72D0926FC9b05b43E359b7ee {
    ...
    const ASSET_SYMBOL: vector<u8> = b"weETH";
    const ASSET_NAME: vector<u8> = b"Wrapped eETH";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/weETH/logo.svg"), /* icon */
            utf8(b"https://www.ether.fi/"), /* project */
        );
