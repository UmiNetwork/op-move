module ERC20::xB1f1F47061A7Be15C69f378CB3f69423bD58F2F8 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"FLASH";
    const ASSET_NAME: vector<u8> = b"Flashstake";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/FLASH/logo.svg"), /* icon */
            utf8(b"https://flashstake.io"), /* project */
        );
