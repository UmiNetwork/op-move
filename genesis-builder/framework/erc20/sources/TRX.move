module ERC20::x50327c6c5a14DCaDE707ABad2E27eB517df87AB5 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"TRX";
    const ASSET_NAME: vector<u8> = b"TRON";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            6, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/TRX/logo.svg"), /* icon */
            utf8(b"https://tron.network"), /* project */
        );
