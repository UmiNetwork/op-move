module ERC20::x8a9c67fee641579deba04928c4bc45f66e26343a {
    ...
    const ASSET_SYMBOL: vector<u8> = b"JRT";
    const ASSET_NAME: vector<u8> = b"Jarvis Reward Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/JRT/logo.svg"), /* icon */
            utf8(b"https://jarvis.network"), /* project */
        );
