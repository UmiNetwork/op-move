module ERC20::x6e15A54B5EcAc17e58daDedDbe8506a7560252F9 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"F";
    const ASSET_NAME: vector<u8> = b"SynFutures";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/F/logo.svg"), /* icon */
            utf8(b"https://www.synfutures.com/"), /* project */
        );
