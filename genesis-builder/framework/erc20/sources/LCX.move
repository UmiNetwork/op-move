module ERC20::x037A54AaB062628C9Bbae1FDB1583c195585fe41 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"LCX";
    const ASSET_NAME: vector<u8> = b"LCX";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/LCX/logo.svg"), /* icon */
            utf8(b"https://lcx.com/"), /* project */
        );
