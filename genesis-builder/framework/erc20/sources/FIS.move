module ERC20::xef3A930e1FfFFAcd2fc13434aC81bD278B0ecC8d {
    ...
    const ASSET_SYMBOL: vector<u8> = b"FIS";
    const ASSET_NAME: vector<u8> = b"StaFi Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/FIS/logo.svg"), /* icon */
