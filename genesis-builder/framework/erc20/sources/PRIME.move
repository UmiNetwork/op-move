module ERC20::xb23d80f5fefcddaa212212f028021b41ded428cf {
    ...
    const ASSET_SYMBOL: vector<u8> = b"PRIME";
    const ASSET_NAME: vector<u8> = b"Prime";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/PRIME/logo.svg"), /* icon */
            utf8(b"https://echelon.io/"), /* project */
        );
