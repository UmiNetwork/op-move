module ERC20::xca1207647Ff814039530D7d35df0e1Dd2e91Fa84 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"DHT";
    const ASSET_NAME: vector<u8> = b"dHEDGE DAO Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/DHT/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
