module ERC20::x92E187a03B6CD19CB6AF293ba17F2745Fd2357D5 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"DUCK";
    const ASSET_NAME: vector<u8> = b"Unit protocol";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/DUCK/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
