module ERC20::x72e4f9F808C49A2a61dE9C5896298920Dc4EEEa9 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"BITCOIN";
    const ASSET_NAME: vector<u8> = b"HarryPotterObamaSonic10Inu";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            8, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/BITCOIN/logo.svg"), /* icon */
            utf8(b"https://hpos10i.com/"), /* project */
        );
