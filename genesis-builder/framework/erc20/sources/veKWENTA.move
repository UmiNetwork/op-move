module ERC20::x6789D8a7a7871923Fc6430432A602879eCB6520a {
    ...
    const ASSET_SYMBOL: vector<u8> = b"veKWENTA";
    const ASSET_NAME: vector<u8> = b"veKwenta";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/veKWENTA/logo.svg"), /* icon */
            utf8(b"https://kips.kwenta.io/kips/kip-34/"), /* project */
        );
