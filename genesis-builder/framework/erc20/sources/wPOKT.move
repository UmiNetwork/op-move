module ERC20::x67f4c72a50f8df6487720261e188f2abe83f57d7 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"wPOKT";
    const ASSET_NAME: vector<u8> = b"Wrapped Pocket";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            6, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/wPOKT/logo.svg"), /* icon */
            utf8(b"https://www.pokt.network/"), /* project */
        );
