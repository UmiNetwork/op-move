module ERC20::xa0246c9032bC3A600820415aE600c6388619A14D {
    ...
    const ASSET_SYMBOL: vector<u8> = b"FARM";
    const ASSET_NAME: vector<u8> = b"FARM Reward Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/FARM/logo.svg"), /* icon */
            utf8(b"https://harvest.finance"), /* project */
        );
