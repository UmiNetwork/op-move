module ERC20::x42d6622dece394b54999fbd73d108123806f6a18 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SPANK";
    const ASSET_NAME: vector<u8> = b"SPANK";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/SPANK/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
