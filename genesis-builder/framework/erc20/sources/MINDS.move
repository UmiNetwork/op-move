module ERC20::xb26631c6dda06ad89b93c71400d25692de89c068 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"MINDS";
    const ASSET_NAME: vector<u8> = b"Minds";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/MINDS/logo.svg"), /* icon */
            utf8(b"https://www.minds.com"), /* project */
        );
