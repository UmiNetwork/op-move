module ERC20::x0d86883FAf4FfD7aEb116390af37746F45b6f378 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"USD3";
    const ASSET_NAME: vector<u8> = b"Web 3 Dollar";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/USD3/logo.svg"), /* icon */
            utf8(b"https://app.reserve.org/ethereum/token/0x0d86883faf4ffd7aeb116390af37746f45b6f378/overview"), /* project */
        );
