module ERC20::xc770eefad204b5180df6a14ee197d99d808ee52d {
    ...
    const ASSET_SYMBOL: vector<u8> = b"FOX";
    const ASSET_NAME: vector<u8> = b"ShapeShift FOX";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/FOX/logo.svg"), /* icon */
            utf8(b"https://shapeshift.com"), /* project */
        );
