module ERC20::x7Fc66500c84A76Ad7e9c93437bFc5Ac33E2DDaE9 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"AAVE";
    const ASSET_NAME: vector<u8> = b"Aave Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/AAVE/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
