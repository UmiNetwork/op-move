module ERC20::x966f17cd63c93c39f38897e5c633e59cef0591f1 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"BOME";
    const ASSET_NAME: vector<u8> = b"BOOK OF MEME";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            6, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/BOME/logo.svg"), /* icon */
            utf8(b"https://bookof.meme"), /* project */
        );
