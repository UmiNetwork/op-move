module ERC20::x69af81e73a73b40adf4f3d4223cd9b1ece623074 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"MASK";
    const ASSET_NAME: vector<u8> = b"Mask Network";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/MASK/logo.svg"), /* icon */
            utf8(b""), /* project */
        );
