module ERC20::xe632ea2ef2cfd8fc4a2731c76f99078aef6a4b31 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"THX";
    const ASSET_NAME: vector<u8> = b"THX Network";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/THX/logo.svg"), /* icon */
            utf8(b"https://www.thx.network"), /* project */
        );
