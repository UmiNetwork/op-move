module ERC20::x2ebd53d035150f328bd754d6dc66b99b0edb89aa {
    ...
    const ASSET_SYMBOL: vector<u8> = b"MET";
    const ASSET_NAME: vector<u8> = b"Metronome2";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/MET/logo.svg"), /* icon */
            utf8(b"https://metronome.io/"), /* project */
        );
