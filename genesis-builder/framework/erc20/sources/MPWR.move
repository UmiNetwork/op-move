module ERC20::x6731827Cb6879a2091ce3ab3423f7bf20539b579 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"MPWR";
    const ASSET_NAME: vector<u8> = b"Empower Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/MPWR/logo.svg"), /* icon */
            utf8(b"https://clubrare.xyz"), /* project */
        );
