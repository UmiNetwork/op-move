module ERC20::x4FbB350052Bca5417566f188eB2EBCE5b19BC964 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"GRG";
    const ASSET_NAME: vector<u8> = b"Rigo Token";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/GRG/logo.svg"), /* icon */
            utf8(b"https://rigoblock.com"), /* project */
        );
