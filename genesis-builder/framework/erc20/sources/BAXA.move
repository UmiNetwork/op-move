module ERC20::x91B08f4A7C1251dfCcF5440F8894F8DaA10c8De5 {
    ...
    const ASSET_SYMBOL: vector<u8> = b"BAXA";
    const ASSET_NAME: vector<u8> = b"BAXagent Coin";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store_u256::create_primary_store_enabled_fungible_asset(
            ...
            18, /* decimals */
            utf8(b"https://ethereum-optimism.github.io/data/BAXA/logo.svg"), /* icon */
            utf8(b"https://baxacoin.com/"), /* project */
        );
