...
async fn test_sending_the_same_payload_twice_produces_one_block() -> anyhow::Result<()> {
    ...
    let expected_response: GetPayloadResponseV3 = GetPayloadResponseV3 {
        execution_payload: ExecutionPayloadV3 {
            parent_hash: B256::new(hex!("a284921edbd3aeb23659b0de076d07209bb666d62c87063e0572fea38745788b")),
            fee_recipient: Address::new(hex!("4200000000000000000000000000000000000011")),
            state_root: B256::new(hex!("ad13dc2f86ca4d8b2083640054c1f9ce8a7a2f7083680482c8acc2d8d6e6bc05")),
            ...
            block_hash: B256::new(hex!("7954bc3c810699a1af6f22e96f958907cb388cdf42882623d6ad84c404414fcd")),
